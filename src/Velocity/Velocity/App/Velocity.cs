...
namespace X3Platform.Velocity.App
{
    using System;
    using System.IO;
    using System.Text;
    ...
    using Context;
    using Exception;
    using X3Platform.Velocity.Runtime.Parser;
    using X3Platform.Velocity.Runtime.Parser.Node;
    using X3Platform.Velocity.Runtime.Resource;
    using Runtime;
    ...
    /// </ul>
    /// <br/><br/>
    /// While the most common way to use X3Platform.Velocity is via templates, as
    /// Velocity is a general-purpose template engine, there are other
    /// uses that X3Platform.Velocity is well suited for, such as processing dynamically
    /// created templates, or processing content streams.
    /// <br/><br/>
    /// The methods herein were developed to allow easy access to the X3Platform.Velocity
    ...
    {
        /// <summary>
        /// initialize the X3Platform.Velocity runtime engine, using the default
        /// properties of the X3Platform.Velocity distribution
        /// </summary>
        ...
        /// <summary>
        /// Clear a X3Platform.Velocity Runtime property.
        /// </summary>
