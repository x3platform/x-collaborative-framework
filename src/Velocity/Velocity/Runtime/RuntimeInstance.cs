...
namespace X3Platform.Velocity.Runtime
{
    using System;
    ...
    using X3Platform.Velocity.Util.Introspection;
    using Resource;
    using Util;
    ...
    public class RuntimeInstance : IRuntimeServices
    {
        ...
        private void setDefaultProperties()
        {
            ...
            {
                debugOutput.WriteLine(string.Format("Cannot get X3Platform.Velocity Runtime default properties!\n{0}", ex.Message));
                debugOutput.Flush();
            }
        }
        ...
        private void initializeResourceManager()
        {
            ...
            if (rmInstance == null && rm != null && rm.Length > 0)
            {
                ...
                if (!(o is IResourceManager))
                {
                    String err =
                        string.Format(
                            "The specified class for ResourceManager ({0}) does not implement ResourceManager. X3Platform.Velocity not initialized correctly.",
                            rm);
                    Error(err);
                    throw new System.Exception(err);
                }
        ...
        private void initializeDirectives()
        {
            ...
            *
            * X3Platform.Velocity.Runtime.Directive.Foreach
            */
        ...
        private void initializeDirectiveManager()
        {
            ...
            {
                throw new System.Exception("Looks like there's no 'directive.manager' configured. X3Platform.Velocity can't go any further");
            }
