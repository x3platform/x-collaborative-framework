...
namespace X3Platform.Velocity.Runtime
{
    ...
    public struct RuntimeConstants
    {
        ...
        public const String DEFAULT_RUNTIME_PROPERTIES = "X3Platform.Velocity.Runtime.Defaults.nvelocity.properties";
        public const String DEFAULT_RUNTIME_DIRECTIVES = "X3Platform.Velocity.Runtime.Defaults.directive.properties";
