...
namespace X3Platform.Velocity.Test
{
	...
	using X3Platform.Velocity.Runtime.Resource.Loader;
	using X3Platform.Velocity.Test.Provider;
	...
	public class TemplateTestCase : BaseTestCase
	{
		...
		public TemplateTestCase()
		{
			...
			{
				throw new Exception("Cannot setup TemplateTestSuite! ("+e.Message+")");
			}
		}
		...
		protected void SetUp()
		{
			...
			*/
			...
			context.Put("runtime", new FieldMethodizer("X3Platform.Velocity.Runtime.RuntimeSingleton"));
