namespace Elane.X.Entities.TestSuite.IBLL
{
    ...
    /// <summary></summary>
    [TestClass]
    public class IEntityOperationLogServiceTestSuite
    {
        ...
        {
            string customTableName = "tb_Entity_OperationLog";
            ...
            IList<EntityOperationLogInfo> list = EntitiesManagement.Instance.EntityOperationLogService.FindAllByEntityId(customTableName, entityId, entityClassName);
