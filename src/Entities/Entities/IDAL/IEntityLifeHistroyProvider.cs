namespace X3Platform.Entities.IDAL
{
    ...
    /// <summary></summary>
    [SpringObject("X3Platform.Entities.IDAL.IEntityLifeHistoryProvider")]
    public interface IEntityLifeHistoryProvider
    {
        // -------------------------------------------------------
        // 事务支持
        // -------------------------------------------------------
        ...
        /// <param name="param">实例<see cref="EntityLifeHistoryInfo"/>详细信息</param>
        void Insert(EntityLifeHistoryInfo param);
        #endregion

        #region 函数:Update(EntityLifeHistoryInfo param)
        /// <summary>修改记录</summary>
        /// <param name="param">实例<see cref="EntityLifeHistoryInfo"/>详细信息</param>
        void Update(EntityLifeHistoryInfo param);
        #endregion
        ...
        IList<EntityLifeHistoryInfo> GetPaging(int startIndex, int pageSize, string whereClause, string orderBy, out int rowCount);
        #endregion
