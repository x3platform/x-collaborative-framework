...
//
// FileName     :IApplicationSettingService.cs
//
// Description  :
//
...
namespace X3Platform.Apps.IBLL
{
    ...
    public interface IApplicationSettingService
    {
        ...
        IList<ApplicationSettingInfo> GetPages(int startIndex, int pageSize, string whereClause, string orderBy, out int rowCount);
        #endregion
