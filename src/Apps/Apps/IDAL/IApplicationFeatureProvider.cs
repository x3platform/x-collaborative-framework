namespace X3Platform.Apps.IDAL
{
    ...
    public interface IApplicationFeatureProvider
    {
        ...
        /// <param name="param">实例<see cref="ApplicationFeatureInfo"/>详细信息</param>
        void Insert(ApplicationFeatureInfo param);
        #endregion

        #region 函数:Update(ApplicationFeatureInfo param)
        /// <summary>修改记录</summary>
        /// <param name="param">实例<see cref="ApplicationFeatureInfo"/>详细信息</param>
        void Update(ApplicationFeatureInfo param);
        #endregion
        ...
        IList<ApplicationFeatureInfo> GetPaging(int startIndex, int pageSize, string whereClause, string orderBy, out int rowCount);
        #endregion
