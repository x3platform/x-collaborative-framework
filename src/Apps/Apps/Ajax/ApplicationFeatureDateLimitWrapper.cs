...
//
// FileName     :ApplicationFeatureDateLimitWrapper.cs
//
// Description  :
//
...
namespace X3Platform.Apps.Ajax
{
    ...
    public class ApplicationFeatureDateLimitWrapper : ContextWrapper
    {
        ...
        public string Save(XmlDocument doc)
        {
            ...
            param = (ApplicationFeatureDateLimitInfo)AjaxStorageConvertor.Deserialize(param, doc);
        ...
        public string FindOne(XmlDocument doc)
        {
            ...
            outString.Append("{\"ajaxStorage\":" + AjaxStorageConvertor.Parse<ApplicationFeatureDateLimitInfo>(param) + ",");
        ...
        public string FindAll(XmlDocument doc)
        {
            ...
            outString.Append("{\"ajaxStorage\":" + AjaxStorageConvertor.Parse<ApplicationFeatureDateLimitInfo>(list) + ",");
        ...
        public string GetPages(XmlDocument doc)
        {
            ...
            IList<ApplicationFeatureDateLimitInfo> list = this.service.GetPages(pages.RowIndex, pages.PageSize, pages.WhereClause, pages.OrderBy, out rowCount);
