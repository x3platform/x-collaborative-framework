...
//
// FileName     :ApplicationEventWrapper.cs
//
// Description  :
//
...
namespace X3Platform.Apps.Ajax
{
    ...
    /// <summary></summary>
    public class ApplicationEventWrapper : ContextWrapper
    {
        /// <summary>���ݷ���</summary>
        private IApplicationEventService service = AppsContext.Instance.ApplicationEventService;
        ...
        {
            ApplicationEventInfo param = new ApplicationEventInfo();

            param = (ApplicationEventInfo)AjaxStorageConvertor.Deserialize(param, doc);
        ...
        public string FindOne(XmlDocument doc)
        {
            ...
            outString.Append("{\"ajaxStorage\":" + AjaxStorageConvertor.Parse<ApplicationEventInfo>(param) + ",");
        ...
        public string FindAll(XmlDocument doc)
        {
            ...
            outString.Append("{\"ajaxStorage\":" + AjaxStorageConvertor.Parse<ApplicationEventInfo>(list) + ",");
