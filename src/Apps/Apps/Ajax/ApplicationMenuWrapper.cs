...
namespace X3Platform.Apps.Ajax
{
    ...
    public class ApplicationMenuWrapper : ContextWrapper
    {
        ...
        public string Save(XmlDocument doc)
        {
            ...
            string authorizationReadScopeObjectText = AjaxStorageConvertor.Fetch("authorizationReadScopeObjectText", doc);

            param = (ApplicationMenuInfo)AjaxStorageConvertor.Deserialize(param, doc);
        ...
        public string FindOne(XmlDocument doc)
        {
            ...
            outString.Append("{\"ajaxStorage\":" + AjaxStorageConvertor.Parse<ApplicationMenuInfo>(param) + ",");
        ...
        public string FindAll(XmlDocument doc)
        {
            ...
            outString.Append("{\"ajaxStorage\":" + AjaxStorageConvertor.Parse<ApplicationMenuInfo>(list) + ",");
