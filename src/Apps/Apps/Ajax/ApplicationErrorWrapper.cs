...
//
// FileName     :ApplicationErrorWrapper.cs
//
// Description  :
//
...
namespace X3Platform.Apps.Ajax
{
    ...
    /// <summary></summary>
    public class ApplicationErrorWrapper : ContextWrapper
    {
        /// <summary>数据服务</summary>
        private IApplicationErrorService service = AppsContext.Instance.ApplicationErrorService;
        ...
        {
            ApplicationErrorInfo param = new ApplicationErrorInfo();

            param = (ApplicationErrorInfo)AjaxStorageConvertor.Deserialize(param, doc);
        ...
        public string FindOne(XmlDocument doc)
        {
            ...
            ApplicationErrorInfo param = this.service.FindOne(id);

            outString.Append("{\"ajaxStorage\":" + AjaxStorageConvertor.Parse<ApplicationErrorInfo>(param) + ",");
        ...
        public string FindAll(XmlDocument doc)
        {
            ...
            IList<ApplicationErrorInfo> list = this.service.FindAll(whereClause, length);

            outString.Append("{\"ajaxStorage\":" + AjaxStorageConvertor.Parse<ApplicationErrorInfo>(list) + ",");
