...
//
// FileName     :ApplicationErrorProvider.cs
//
// Description  :
//
...
namespace X3Platform.Apps.DAL.IBatis
{
    ...
    /// <summary></summary>
    [DataObject]
    public class ApplicationErrorProvider : IApplicationErrorProvider
    {
        /// <summary>配置</summary>
        ...
        private string tableName = "tb_Application_Error";

        #region 构造函数:ApplicationErrorProvider()
        ...
        #region 函数:Insert(ApplicationErrorInfo param)
        /// <summary>添加记录</summary>
        /// <param name="param">实例<see cref="ApplicationErrorInfo"/>详细信息</param>
        public void Insert(ApplicationErrorInfo param)
        {
            this.ibatisMapper.Insert(StringHelper.ToProcedurePrefix(string.Format("{0}_Insert", this.tableName)), param);
        }
        #endregion

        #region 函数:Update(ApplicationErrorInfo param)
        /// <summary>修改记录</summary>
        /// <param name="param">实例<see cref="ApplicationErrorInfo"/>详细信息</param>
        public void Update(ApplicationErrorInfo param)
        {
        ...
        public ApplicationErrorInfo FindOne(string id)
        {
            ...
            return this.ibatisMapper.QueryForObject<ApplicationErrorInfo>(StringHelper.ToProcedurePrefix(string.Format("{0}_FindOne", this.tableName)), args);
        }
        #endregion
        ...
        public ApplicationErrorInfo FindOneByCode(string code)
        {
            ...
            return this.ibatisMapper.QueryForObject<ApplicationErrorInfo>(StringHelper.ToProcedurePrefix(string.Format("{0}_FindOneByCode", this.tableName)), args);
        }
        #endregion
        ...
        public IList<ApplicationErrorInfo> FindAll(string whereClause, int length)
        {
            ...
            return this.ibatisMapper.QueryForList<ApplicationErrorInfo>(StringHelper.ToProcedurePrefix(string.Format("{0}_FindAll", this.tableName)), args);
        }
        #endregion
        ...
        public IList<ApplicationErrorInfo> GetPages(int startIndex, int pageSize, string whereClause, string orderBy, out int rowCount)
        {
            Dictionary<string, object> args = new Dictionary<string, object>();
            ...
            IList<ApplicationErrorInfo> list = this.ibatisMapper.QueryForList<ApplicationErrorInfo>(StringHelper.ToProcedurePrefix(string.Format("{0}_GetPages", this.tableName)), args);
