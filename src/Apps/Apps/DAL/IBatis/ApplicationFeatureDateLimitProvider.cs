namespace X3Platform.Apps.DAL.IBatis
{
    ...
    /// <summary></summary>
    [DataObject]
    public class ApplicationFeatureDateLimitProvider : IApplicationFeatureDateLimitProvider
    {
        /// <summary>配置</summary>
        ...
        private string tableName = "tb_Application_FeatureDateLimit";

        #region 构造函数:ApplicationFeatureDateLimitProvider()
        /// <summary>构造函数</summary>
        public ApplicationFeatureDateLimitProvider()
        {
        ...
        /// <param name="param">实例<see cref="ApplicationFeatureDateLimitInfo"/>详细信息</param>
        public void Insert(ApplicationFeatureDateLimitInfo param)
        {
        ...
        /// <param name="param">实例<see cref="ApplicationFeatureDateLimitInfo"/>详细信息</param>
        public void Update(ApplicationFeatureDateLimitInfo param)
        {
        ...
        public ApplicationFeatureDateLimitInfo FindOne(string id)
        {
            ...
            return this.ibatisMapper.QueryForObject<ApplicationFeatureDateLimitInfo>(StringHelper.ToProcedurePrefix(string.Format("{0}_FindOne", this.tableName)), args);
        }
        #endregion
        ...
        public IList<ApplicationFeatureDateLimitInfo> FindAll(string whereClause, int length)
        {
            ...
            return this.ibatisMapper.QueryForList<ApplicationFeatureDateLimitInfo>(StringHelper.ToProcedurePrefix(string.Format("{0}_FindAll", this.tableName)), args);
        }
        #endregion
        ...
        public IList<ApplicationFeatureDateLimitInfo> GetPaging(int startIndex, int pageSize, string whereClause, string orderBy, out int rowCount)
        {
            Dictionary<string, object> args = new Dictionary<string, object>();
            ...
            IList<ApplicationFeatureDateLimitInfo> list = this.ibatisMapper.QueryForList<ApplicationFeatureDateLimitInfo>(StringHelper.ToProcedurePrefix(string.Format("{0}_GetPages", this.tableName)), args);
