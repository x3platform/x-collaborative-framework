...
namespace X3Platform.Apps.DAL.IBatis
{
    ...
    public class ApplicationPackageLogProvider : IApplicationPackageLogProvider
    {
        ...
        public IList<ApplicationPackageLogInfo> GetPages(int startIndex, int pageSize, string whereClause, string orderBy, out int rowCount)
        {
            Dictionary<string, object> args = new Dictionary<string, object>();
            ...
            IList<ApplicationPackageLogInfo> list = ibatisMapper.QueryForList<ApplicationPackageLogInfo>(StringHelper.ToProcedurePrefix(string.Format("{0}_GetPages", tableName)), args);
