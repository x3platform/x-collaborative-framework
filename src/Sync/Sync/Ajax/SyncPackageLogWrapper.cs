...
namespace X3Platform.Apps.Ajax
{
    ...
    public class ApplicationPackageLogWrapper : ContextWrapper
    {
        ...
        public string Save(XmlDocument doc)
        {
            ...
            param = (ApplicationPackageLogInfo)AjaxUtil.Deserialize(param, doc);
        ...
        public string GetPages(XmlDocument doc)
        {
            ...
            IList<ApplicationPackageLogInfo> list = this.service.GetPaging(pages.RowIndex, pages.PageSize, pages.WhereClause, pages.OrderBy, out rowCount);
