...
x.ui.wizards.newContactsWizard = function(name, targetViewName, targetValueName, options)
{
    var wizard = {
        ...
        */
        ...
        /*#region 函数:findAllByOrganizationUnitId(organizationId)*/
        findAllByOrganizationUnitId: function(organizationId)
        {
            var outString = '<?xml version="1.0" encoding="utf-8" ?>';

            outString += '<request>';
            outString += '<action><![CDATA[findAllByOrganizationUnitId]]></action>';
            outString += '<clientTargetObject><![CDATA[' + this.name + ']]></clientTargetObject>';
            outString += '<contactType><![CDATA[' + this.contactType + ']]></contactType>';
            outString += '<includeProhibited><![CDATA[' + this.includeProhibited + ']]></includeProhibited>';
            ...
            x.net.xhr('/api/membership.contacts.findAllByOrganizationUnitId.aspx', outString, {
                callback: this.findAll_callback
            });
        },
        /*#endregion*/

        /*#region 函数:findAllByStandardOrganizationUnitId(standardOrganizationId)*/
        findAllByStandardOrganizationUnitId: function(standardOrganizationId)
        {
            var outString = '<?xml version="1.0" encoding="utf-8" ?>';
            ...
            x.net.xhr('/api/membership.contacts.findAllByStandardOrganizationUnitId.aspx', outString, {
                callback: this.findAll_callback
            });
        },
        /*#endregion*/
        ...
        getTreeView: function(treeViewType)
        {
            ...
            switch (treeViewType)
            {
                case 'organization':
                    ...
                    treeViewUrl = 'javascript:' + this.name + '.findAllByOrganizationUnitId(\'{treeNodeId}\')';
                    break;
                case 'my-corporation':
                ...
                case 'standard-organization':
                    ...
                    treeViewName = '标准组织';
                    treeViewRootTreeNodeId = '00000000-0000-0000-0000-000000000001';
                    treeViewUrl = 'javascript:' + this.name + '.findAllByStandardOrganizationUnitId(\'{treeNodeId}\')';
                    break;
                case 'standard-role':
