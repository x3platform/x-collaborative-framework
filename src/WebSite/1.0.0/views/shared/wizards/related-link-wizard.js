    ...
    var wizard = {
        ...
        */
        create: function()
        {
            ...
            outString += '<div class="float-left button-4font-wrapper" style="margin-right:10px;" ><a href="javascript:' + this.name + '.add();" class="button-text" >添加链接</a></div>';
            outString += '<div class="float-left button-2font-wrapper" style="margin-right:10px;" ><a href="javascript:' + this.name + '.save();" class="button-text" >保存</a></div>';
            outString += '<div class="clear"></div>';
            outString += '</div>';
            outString += '</td>';
            outString += '</tr>';
