...
main.applications.application.setting.group.list = {
  ...
  */
  ...
  {
    // 调整页面结构尺寸
    main.applications.application.setting.group.list.resize();
...
// 重新调整页面大小
$(window).resize(main.applications.application.setting.group.list.resize);
// 重新调整页面大小
$(document.body).resize(main.applications.application.setting.group.list.resize);
