...
main.applications.application.method.list = {
  ...
  */
  getObjectsView: function(list, maxCount)
  {
    ...
    outString += '<thead>';
    outString += '<tr>';
    outString += '<th style="width:120px">方法代码</th>';
    outString += '<th >名称</th>';
  ...
  */
  getObjectView: function(param)
  {
    ...
    outString += '<li><a href="#tab-2">备注</a></li>';
    outString += '</ul>';
    outString += '</div>';
    ...
    outString += '<td class="table-body-input" colspan="3" ><textarea id="description" name="description" rows="3" class="form-control" style="width:460px;" />' + x.isUndefined(param.description, '') + '</textarea></td>';
    outString += '</tr>';
    ...
    outString += '<div class="x-ui-pkg-tabs-container" >';
    outString += '<h2 class="x-ui-pkg-tabs-container-head-hidden"><a name="tab-2" id="tab-2">备注</a></h2>';

    outString += '<table class="table-style" style="width:100%">';
    outString += '<tr class="table-row-normal-transparent">';
    outString += '<td class="table-body-text" style="width:120px" >备注</td>';
    outString += '<td class="table-body-input" ><textarea id="remark" name="remark" type="text" x-dom-data-type="value" class="textarea-normal" style="width:460px;height:80px;" >' + (typeof (param.remark) === 'undefined' ? '' : param.remark) + '</textarea></td>';
    outString += '</tr>';
    outString += '</table>';
    outString += '</div>';
