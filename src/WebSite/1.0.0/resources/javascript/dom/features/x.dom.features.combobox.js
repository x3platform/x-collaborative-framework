        ...
        x.require({
            ...
            callback: function(context)
            {
                ...
                else
                {
                    ...
                    $('#' + viewName).wrap('<div id="' + classNamePrefix + '-' + inputName + '-wrapper" class="input-group dropdown" style="width:' + width + 'px;"></div>');
                    $('#' + viewName).after('<div class="input-group-addon"><span class="glyphicon glyphicon-list" ></span></div>');
                }

                $('#' + viewName).after('<div id="' + comboboxName + '" class="dropdown-menu" style="width:' + width + 'px;display:none;" ></div>');
