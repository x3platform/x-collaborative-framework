    ...
    newApprovalRecordTab: function(name, targetContainerName, options)
    {
        var tab = {
                    ...
                    callback: function(response)
                    {
                        ...
                        x.net.xhr('/api/workflow.instance.getTemplateByWorkflowInstanceId.aspx', outString, {
                            callback: function(response)
                            {
                                ...
                                {
                                    outString += '<table class="table table-bordered" >';
            ...
            create: function()
            {
                ...
                outString += '<table class="table table-bordered" style="width:100%; margin-bottom:10px;" >';
                outString += '<tr>';
        ...
        var tab = {
            ...
            */
                    ...
                    x.net.xhr('/api/workflow.historyNode.findAllForcedRequest.aspx', outString, {
                        callback: function(response)
                        {
                            ...
                            if(list.length > 0)
                            {
                                ...
                                outString += '<th style="width: 160px;">反馈时间</th>';
                                outString += '</tr>';
                    ...
                    x.net.xhr('/api/kernel.entities.operationLog.findAllByEntityId.aspx', outString, {
                        callback: function(response)
                        {
                            ...
                            if(list.length > 0)
                            {
                                ...
                                outString += '<th style="width: 160px;">催办时间</th>';
                                outString += '</tr>';
                    ...
                    x.net.xhr('/api/kernel.entities.operationLog.findAllByEntityId.aspx', outString, {
                        callback: function(response)
                        {
                            ...
                            if(list.length > 0)
                            {
                                ...
                                outString += '<th style="width: 160px;">推荐时间</th>';
                                outString += '</tr>';
            ...
            create: function()
            {
                ...
                outString += '<table id="' + this.name + '$table" style="width: 100%;" class="table-style table-bordered">';
    ...
    newClickTab: function(name, targetContainerName, options)
    {
        var tab = {
            ...
            create: function()
            {
                ...
                outString += '<table id="' + this.name + '$table" style="width: 100%;" class="table table-bordered">';
            ...
            refresh: function()
            {
                ...
                x.net.xhr('/api/kernel.entities.implementation.findAllByEntityId.aspx', outString, {
                    callback: function(response)
                    {
                        ...
                        {
                            outString += '<table style="width: 100%;" class="table-style table-bordered-table">';
