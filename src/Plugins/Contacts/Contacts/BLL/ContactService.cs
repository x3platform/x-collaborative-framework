...
namespace X3Platform.Plugins.Contacts.BLL
{
    ...
    public class ContactService : IContactService
    {
        ...
        {
            return this.provider.Query(startIndex, pageSize, this.BindAuthorizationScopeSQL(whereClause), orderBy, out rowCount);
        }
        #endregion
