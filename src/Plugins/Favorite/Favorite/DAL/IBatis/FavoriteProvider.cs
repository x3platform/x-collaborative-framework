...
namespace X3Platform.Plugins.Favorite.DAL.IBatis
{
    ...
    public class FavoriteProvider : IFavoriteProvider
    {
        ...
        private string tableName = "tb_Favorite";

        #region 构造函数:FavoriteProvider()
        ...
        public IList<FavoriteInfo> FindAll(string whereClause, int length)
        {
            ...
            IList<FavoriteInfo> list = this.ibatisMapper.QueryForList<FavoriteInfo>(StringHelper.ToProcedurePrefix(string.Format("{0}_FindAll", this.tableName)), args);
        ...
        public IList<FavoriteInfo> GetPages(int startIndex, int pageSize, string whereClause, string orderBy, out int rowCount)
        {
            ...
            IList<FavoriteInfo> list = this.ibatisMapper.QueryForList<FavoriteInfo>(StringHelper.ToProcedurePrefix(string.Format("{0}_GetPages", this.tableName)), args);
        ...
        public bool SetClick(string id)
        {
            ...
            try
            {
                ...
                ibatisMapper.Update("proc_Favorite_SetClick", args);
