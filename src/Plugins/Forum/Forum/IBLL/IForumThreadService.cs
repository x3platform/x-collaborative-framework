namespace X3Platform.Plugins.Forum.IBLL
{
  ...
  using X3Platform.Data;
    ...
    /// <summary></summary>
    [SpringObject("X3Platform.Plugins.Forum.IBLL.IForumThreadService")]
    public interface IForumThreadService
    {
        ...
        /// <returns>返回所有实例<see cref="ForumThreadInfo"/>的详细信息</returns>
        IList<ForumThreadInfo> FindAll(string whereClause);
        #endregion
