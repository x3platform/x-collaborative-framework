...
//
// FileName     :IForumCommentService.cs
//
// Description  :
//
// Author       :RuanYu
...
namespace X3Platform.Plugins.Forum.IBLL
{
  ...
  using X3Platform.Data;
    ...
    /// <summary></summary>
    [SpringObject("X3Platform.Plugins.Forum.IBLL.IForumCommentService")]
    public interface IForumCommentService
    {
        ...
        IList<ForumCommentInfo> FindAll();
        #endregion
        ...
        /// <returns>返回所有实例<see cref="ForumCommentInfo"/>的详细信息</returns>
        IList<ForumCommentInfo> FindAll(string whereClause);
        #endregion
