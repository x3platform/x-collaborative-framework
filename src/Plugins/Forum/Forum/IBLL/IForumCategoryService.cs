...
//
// FileName     :IForumCategoryService.cs
//
// Description  :
//
// Author       :RuanYu
...
namespace X3Platform.Plugins.Forum.IBLL
{
  ...
  using X3Platform.Data;
    ...
    /// <summary></summary>
    [SpringObject("X3Platform.Plugins.Forum.IBLL.IForumCategoryService")]
    public interface IForumCategoryService
    {
        ...
        ForumCategoryInfo FindOne(string ids);
        #endregion
        ...
        IList<ForumCategoryInfo> FindAll();
        #endregion
        ...
        /// <returns>返回所有实例<see cref="ForumCategoryInfo"/>的详细信息</returns>
        IList<ForumCategoryInfo> FindAll(string whereClause);
        #endregion
        ...
        ICategoryIndex FetchCategoryIndex(string isStatus);
        #endregion
