...
set TargetIBatisResourceDir=%TrunkDir%WebSite\1.0.0\resources\ibatis\Storages\
...
set TargetIBatisResourceDir=%TrunkDir%WebSite\1.1.0\resources\ibatis\Storages\
