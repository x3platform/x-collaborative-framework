namespace X3Platform.Storages.IDAL
{
    ...
    /// <summary></summary>
    [SpringObject("X3Platform.Storages.IDAL.IStorageNodeProvider")]
    public interface IStorageNodeProvider
    {
        // -------------------------------------------------------
        // 事务支持
        // -------------------------------------------------------
        ...
        /// <param name="param">实例<see cref="IStorageNode"/>详细信息</param>
        void Insert(IStorageNode param);
        #endregion

        #region 函数:Update(IStorageNode param)
        /// <summary>修改记录</summary>
        /// <param name="param">实例<see cref="IStorageNode"/>详细信息</param>
        void Update(IStorageNode param);
        #endregion
        ...
        IList<IStorageNode> FindAll(DataQuery query);
        #endregion
        ...
        IList<IStorageNode> GetPaging(int startIndex, int pageSize, DataQuery query, out int rowCount);
        #endregion
