...
namespace X3Platform.Web.Builder.Layouts.CollaborationPlatform
{
    ...
    public class NavigationBuilder : CommonBuilder, INavigationBuilder
    {
        ...
        public string GetTopMenu(IAccountInfo account)
        {
            ...
            return VelocityManager.Instance.Merge(context, "web/builder/themes/collaboration/NavigationBuilder.GetTopMenu.vm");
        }
        #endregion
        ...
        public string GetBottomMenu(IAccountInfo account)
        {
            ...
            return VelocityManager.Instance.Merge(context, "web/builder/themes/collaboration/NavigationBuilder.GetBottomMenu.vm");
        }
        #endregion
