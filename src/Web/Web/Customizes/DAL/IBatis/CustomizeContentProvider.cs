namespace X3Platform.Web.Customizes.DAL.IBatis
{
  ...
  /// <summary></summary>
  [DataObject]
  public class CustomizeContentProvider : ICustomizeContentProvider
  {
    ...
    private string tableName = "tb_Customize_Content";

    #region 构造函数:CustomizeContentProvider()
    /// <summary>构造函数</summary>
    public CustomizeContentProvider()
    {
    ...
    public void Insert(CustomizeContentInfo param)
    {
    ...
    /// <param name="param">CustomizeContentInfo 实例的详细信息</param>
    public void Update(CustomizeContentInfo param)
    {
    ...
    /// <param name="param">CustomizeContentInfo Id号</param>
    ...
    public CustomizeContentInfo FindOne(string id)
    {
      ...
      return this.ibatisMapper.QueryForObject<CustomizeContentInfo>(StringHelper.ToProcedurePrefix(string.Format("{0}_FindOne", tableName)), args);
    }
    #endregion
    ...
    public CustomizeContentInfo FindOneByName(string name)
    {
      ...
      return this.ibatisMapper.QueryForObject<CustomizeContentInfo>(StringHelper.ToProcedurePrefix(string.Format("{0}_FindOneByName", tableName)), args);
    }
    #endregion
    ...
    public IList<CustomizeContentInfo> FindAll(string whereClause, int length)
    {
      ...
      return this.ibatisMapper.QueryForList<CustomizeContentInfo>(StringHelper.ToProcedurePrefix(string.Format("{0}_FindAll", tableName)), args);
    }
    #endregion
    ...
    public IList<CustomizeContentInfo> GetPaging(int startIndex, int pageSize, DataQuery query, out int rowCount)
    {
      ...
      IList<CustomizeContentInfo> list = this.ibatisMapper.QueryForList<CustomizeContentInfo>(StringHelper.ToProcedurePrefix(string.Format("{0}_GetPaging", tableName)), args);
