namespace X3Platform.Web.Customizes.DAL.IBatis
{
  ...
  /// <summary></summary>
  [DataObject]
  public class CustomizeWidgetZoneProvider : ICustomizeWidgetZoneProvider
  {
    ...
    private string tableName = "tb_Customize_WidgetZone";

    #region 构造函数:CustomizeWidgetZoneProvider()
    /// <summary>构造函数</summary>
    public CustomizeWidgetZoneProvider()
    {
