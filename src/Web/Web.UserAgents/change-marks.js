...
var ignoreFiles = ['README.md', 'change-marks.js', '.csproj'],
...
{
    before: 'UAParser',
    after: 'X3Platform.Web.UserAgents'
},
{
    before: 'YamlDotNet',
    after: 'X3Platform.Yaml'
},
{
    before: '"UAParser.regexes.yaml"',
    after: '"X3Platform.Web.UserAgents.defaults.regexes.yaml"'
}];
