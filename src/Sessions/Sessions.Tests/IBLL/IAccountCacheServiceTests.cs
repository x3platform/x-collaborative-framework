namespace X3Platform.Sessions.Tests.Sessions
{
  using System;
  ...
  [TestClass]
  public class ISessionNodeServiceTests
  {
    [TestMethod]
    ...
    {
      IList<AccountCacheInfo> list = SessionContext.Instance.AccountCacheService.Dump();
