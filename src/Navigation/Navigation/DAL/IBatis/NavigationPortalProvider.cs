...
//
// FileName     :NavigationPortalProvider.cs
//
// Description  :
//
...
namespace X3Platform.Navigation.DAL.IBatis
{
    ...
    /// <summary></summary>
    [DataObject]
    public class NavigationPortalProvider : INavigationPortalProvider
    {
        /// <summary>配置</summary>
        ...
        private string tableName = "tb_Navigation_Portal";

        #region 构造函数:NavigationPortalProvider()
        /// <summary>构造函数</summary>
        public NavigationPortalProvider()
        {
        ...
        #region 函数:Insert(NavigationPortalInfo param)
        ...
        #region 函数:Update(NavigationPortalInfo param)
        ...
        public NavigationPortalInfo FindOne(string id)
        {
            ...
            return this.ibatisMapper.QueryForObject<NavigationPortalInfo>(StringHelper.ToProcedurePrefix(string.Format("{0}_FindOne", this.tableName)), args);
        }
        #endregion
        ...
        /// <returns>返回所有实例<see cref="NavigationPortalInfo"/>的详细信息</returns>
        public IList<NavigationPortalInfo> FindAll(string whereClause, int length)
        {
            ...
            return this.ibatisMapper.QueryForList<NavigationPortalInfo>(StringHelper.ToProcedurePrefix(string.Format("{0}_FindAll", this.tableName)), args);
        }
        #endregion
        ...
        /// <returns>返回一个列表实例<see cref="NavigationPortalInfo"/></returns>
        public IList<NavigationPortalInfo> GetPages(int startIndex, int pageSize, string whereClause, string orderBy, out int rowCount)
        {
            ...
            IList<NavigationPortalInfo> list = this.ibatisMapper.QueryForList<NavigationPortalInfo>(StringHelper.ToProcedurePrefix(string.Format("{0}_GetPages", this.tableName)), args);
