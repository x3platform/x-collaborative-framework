...
//
// FileName     :NavigationPortalSidebarItemProvider.cs
//
// Description  :
//
...
namespace X3Platform.Navigation.DAL.IBatis
{
    ...
    /// <summary></summary>
    [DataObject]
    public class NavigationPortalSidebarItemProvider : INavigationPortalSidebarItemProvider
    {
        /// <summary>配置</summary>
        ...
        private string tableName = "tb_Navigation_Portal_SidebarItem";

        #region 构造函数:NavigationPortalSidebarItemProvider()
        /// <summary>构造函数</summary>
        public NavigationPortalSidebarItemProvider()
        {
        ...
        #region 函数:Save(NavigationPortalSidebarItemInfo param)
        /// <summary>保存记录</summary>
        /// <param name="param">实例<see cref="NavigationPortalSidebarItemInfo"/>详细信息</param>
        /// <returns>实例<see cref="NavigationPortalSidebarItemInfo"/>详细信息</returns>
        ...
        #region 函数:Insert(NavigationPortalSidebarItemInfo param)
        /// <summary>添加记录</summary>
        /// <param name="param">实例<see cref="NavigationPortalSidebarItemInfo"/>详细信息</param>
        public void Insert(NavigationPortalSidebarItemInfo param)
        {
            this.ibatisMapper.Insert(StringHelper.ToProcedurePrefix(string.Format("{0}_Insert", this.tableName)), param);
        }
        #endregion

        #region 函数:Update(NavigationPortalSidebarItemInfo param)
        /// <summary>修改记录</summary>
        /// <param name="param">实例<see cref="NavigationPortalSidebarItemInfo"/>详细信息</param>
        public void Update(NavigationPortalSidebarItemInfo param)
        {
        ...
        /// <returns>返回实例<see cref="NavigationPortalSidebarItemInfo"/>的详细信息</returns>
        public NavigationPortalSidebarItemInfo FindOne(string id)
        {
            ...
            return this.ibatisMapper.QueryForObject<NavigationPortalSidebarItemInfo>(StringHelper.ToProcedurePrefix(string.Format("{0}_FindOne", this.tableName)), args);
        }
        #endregion
        ...
        /// <returns>返回所有实例<see cref="NavigationPortalSidebarItemInfo"/>的详细信息</returns>
        public IList<NavigationPortalSidebarItemInfo> FindAll(string whereClause, int length)
        {
            ...
            return this.ibatisMapper.QueryForList<NavigationPortalSidebarItemInfo>(StringHelper.ToProcedurePrefix(string.Format("{0}_FindAll", this.tableName)), args);
        }
        #endregion
        ...
        #region 函数:FindAllBySidebarItemGroupId(string sidebarItemGroupId)
        /// <summary>查询所有相关记录</summary>
        /// <param name="sidebarItemGroupId">所属侧栏菜单项分组标识</param>
        /// <returns>返回所有实例<see cref="NavigationPortalSidebarItemInfo"/>的详细信息</returns>
        public IList<NavigationPortalSidebarItemInfo> FindAllBySidebarItemGroupId(string sidebarItemGroupId)
        {
            string whereClause = string.Format(" SidebarItemGroupId = ##{0}## ORDER BY OrderId ", sidebarItemGroupId);
        ...
        /// <returns>返回一个列表实例<see cref="NavigationPortalSidebarItemInfo"/></returns>
        public IList<NavigationPortalSidebarItemInfo> GetPages(int startIndex, int pageSize, string whereClause, string orderBy, out int rowCount)
        {
            ...
            IList<NavigationPortalSidebarItemInfo> list = this.ibatisMapper.QueryForList<NavigationPortalSidebarItemInfo>(StringHelper.ToProcedurePrefix(string.Format("{0}_GetPages", this.tableName)), args);
