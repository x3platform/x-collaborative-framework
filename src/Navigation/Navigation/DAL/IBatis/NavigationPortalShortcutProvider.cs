...
//
// FileName     :NavigationPortalShortcutProvider.cs
//
// Description  :
//
...
namespace X3Platform.Navigation.DAL.IBatis
{
    ...
    /// <summary></summary>
    [DataObject]
    public class NavigationPortalShortcutProvider : INavigationPortalShortcutProvider
    {
        /// <summary>配置</summary>
        ...
        private string tableName = "tb_Navigation_Portal_Shortcut";

        #region 构造函数:NavigationPortalShortcutProvider()
        /// <summary>构造函数</summary>
        public NavigationPortalShortcutProvider()
        {
        ...
        #region 函数:Insert(NavigationPortalShortcutInfo param)
        /// <summary>添加记录</summary>
        /// <param name="param">实例<see cref="NavigationPortalShortcutInfo"/>详细信息</param>
        public void Insert(NavigationPortalShortcutInfo param)
        {
            this.ibatisMapper.Insert(StringHelper.ToProcedurePrefix(string.Format("{0}_Insert", this.tableName)), param);
        }
        #endregion

        #region 函数:Update(NavigationPortalShortcutInfo param)
        ...
        /// <returns>返回实例<see cref="NavigationPortalShortcutInfo"/>的详细信息</returns>
        public NavigationPortalShortcutInfo FindOne(string id)
        {
            ...
            return this.ibatisMapper.QueryForObject<NavigationPortalShortcutInfo>(StringHelper.ToProcedurePrefix(string.Format("{0}_FindOne", this.tableName)), args);
        }
        #endregion
        ...
        /// <returns>返回所有实例<see cref="NavigationPortalShortcutInfo"/>的详细信息</returns>
        public IList<NavigationPortalShortcutInfo> FindAll(string whereClause, int length)
        {
            ...
            return this.ibatisMapper.QueryForList<NavigationPortalShortcutInfo>(StringHelper.ToProcedurePrefix(string.Format("{0}_FindAll", this.tableName)), args);
        }
        #endregion
        ...
        #region 函数:FindAllByShortcutGroupId(string shortcutGroupId)
        /// <summary>查询所有相关记录</summary>
        /// <param name="shortcutGroupId">所属快捷方式分组标识</param>
        /// <returns>返回所有实例<see cref="NavigationPortalShortcutInfo"/>的详细信息</returns>
        public IList<NavigationPortalShortcutInfo> FindAllByShortcutGroupId(string shortcutGroupId)
        {
            string whereClause = string.Format(" ShortcutGroupId = ##{0}## ORDER BY OrderId ", shortcutGroupId);
        ...
        /// <returns>返回一个列表实例<see cref="NavigationPortalShortcutInfo"/></returns>
        public IList<NavigationPortalShortcutInfo> GetPages(int startIndex, int pageSize, string whereClause, string orderBy, out int rowCount)
        {
            ...
            IList<NavigationPortalShortcutInfo> list = this.ibatisMapper.QueryForList<NavigationPortalShortcutInfo>(StringHelper.ToProcedurePrefix(string.Format("{0}_GetPages", this.tableName)), args);
