...
//
// FileName     :NavigationPortalSidebarItemGroupProvider.cs
//
// Description  :
//
...
namespace X3Platform.Navigation.DAL.IBatis
{
    ...
    /// <summary></summary>
    [DataObject]
    public class NavigationPortalSidebarItemGroupProvider : INavigationPortalSidebarItemGroupProvider
    {
        /// <summary>配置</summary>
        ...
        private string tableName = "tb_Navigation_Portal_SidebarItemGroup";

        #region 构造函数:NavigationPortalSidebarItemGroupProvider()
        /// <summary>构造函数</summary>
        public NavigationPortalSidebarItemGroupProvider()
        {
        ...
        #region 函数:Save(NavigationPortalSidebarItemGroupInfo param)
        /// <summary>保存记录</summary>
        /// <param name="param">实例<see cref="NavigationPortalSidebarItemGroupInfo"/>详细信息</param>
        /// <returns>实例<see cref="NavigationPortalSidebarItemGroupInfo"/>详细信息</returns>
        ...
        #region 函数:Insert(NavigationPortalSidebarItemGroupInfo param)
        /// <summary>添加记录</summary>
        /// <param name="param">实例<see cref="NavigationPortalSidebarItemGroupInfo"/>详细信息</param>
        public void Insert(NavigationPortalSidebarItemGroupInfo param)
        {
            this.ibatisMapper.Insert(StringHelper.ToProcedurePrefix(string.Format("{0}_Insert", this.tableName)), param);
        }
        #endregion

        #region 函数:Update(NavigationPortalSidebarItemGroupInfo param)
        /// <summary>修改记录</summary>
        /// <param name="param">实例<see cref="NavigationPortalSidebarItemGroupInfo"/>详细信息</param>
        public void Update(NavigationPortalSidebarItemGroupInfo param)
        {
        ...
        /// <returns>返回实例<see cref="NavigationPortalSidebarItemGroupInfo"/>的详细信息</returns>
        public NavigationPortalSidebarItemGroupInfo FindOne(string id)
        {
            ...
            return this.ibatisMapper.QueryForObject<NavigationPortalSidebarItemGroupInfo>(StringHelper.ToProcedurePrefix(string.Format("{0}_FindOne", this.tableName)), args);
        }
        #endregion
        ...
        /// <returns>返回所有实例<see cref="NavigationPortalSidebarItemGroupInfo"/>的详细信息</returns>
        public IList<NavigationPortalSidebarItemGroupInfo> FindAll(string whereClause, int length)
        {
            ...
            return this.ibatisMapper.QueryForList<NavigationPortalSidebarItemGroupInfo>(StringHelper.ToProcedurePrefix(string.Format("{0}_FindAll", this.tableName)), args);
        }
        #endregion
        ...
        /// <returns>返回一个列表实例<see cref="NavigationPortalSidebarItemGroupInfo"/></returns>
        public IList<NavigationPortalSidebarItemGroupInfo> GetPages(int startIndex, int pageSize, string whereClause, string orderBy, out int rowCount)
        {
            ...
            IList<NavigationPortalSidebarItemGroupInfo> list = this.ibatisMapper.QueryForList<NavigationPortalSidebarItemGroupInfo>(StringHelper.ToProcedurePrefix(string.Format("{0}_GetPages", this.tableName)), args);
