...
namespace X3Platform.Navigation.IDAL
{
    ...
    public interface INavigationPortalProvider
    {
        ...
        #region ����:Save(NavigationPortalInfo param)
        /// <summary>������¼</summary>
        ...
        #region ����:Insert(NavigationPortalInfo param)
        /// <summary>���Ӽ�¼</summary>
        /// <param name="param">ʵ��<see cref="NavigationPortalInfo"/>��ϸ��Ϣ</param>
        void Insert(NavigationPortalInfo param);
        #endregion

        #region ����:Update(NavigationPortalInfo param)
        /// <summary>�޸ļ�¼</summary>
        /// <param name="param">ʵ��<see cref="NavigationPortalInfo"/>��ϸ��Ϣ</param>
        ...
        #region ����:FindOneByOrganizationId(string organizationId)
        /// <summary>��ѯĳ����¼</summary>
