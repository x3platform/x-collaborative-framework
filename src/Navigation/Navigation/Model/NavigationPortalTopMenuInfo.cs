...
//
// FileName     :NavigationPortalTopMenuInfo.cs
//
// Description  :
//
...
namespace X3Platform.Navigation.Model
{
    ...
    /// <summary></summary>
    public class NavigationPortalTopMenuInfo : ICacheable
    {
        #region ���캯��:NavigationPortalTopMenuInfo()
        /// <summary>Ĭ�Ϲ��캯��</summary>
        public NavigationPortalTopMenuInfo()
        {
        }
        #endregion
