...
//
// FileName     :NavigationPortalSidebarItemGroupInfo.cs
//
// Description  :
//
...
namespace X3Platform.Navigation.Model
{
    ...
    /// <summary></summary>
    public class NavigationPortalSidebarItemGroupInfo : ICacheable
    {
        #region ���캯��:NavigationPortalSidebarItemGroupInfo()
        /// <summary>Ĭ�Ϲ��캯��</summary>
        public NavigationPortalSidebarItemGroupInfo()
        {
        }
        #endregion
