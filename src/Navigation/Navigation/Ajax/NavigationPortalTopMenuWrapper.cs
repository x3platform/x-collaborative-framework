...
//
// FileName     :NavigationPortalTopMenuWrapper.cs
//
// Description  :
//
...
namespace X3Platform.Navigation.Ajax
{
    ...
    /// <summary></summary>
    public class NavigationPortalTopMenuWrapper : ContextWrapper
    {
        /// <summary>���ݷ���</summary>
        private INavigationPortalTopMenuService service = NavigationContext.Instance.NavigationPortalTopMenuService;
        ...
        {
            NavigationPortalTopMenuInfo param = new NavigationPortalTopMenuInfo();

            param = (NavigationPortalTopMenuInfo)AjaxStorageConvertor.Deserialize(param, doc);
        ...
        public string FindOne(XmlDocument doc)
        {
            ...
            NavigationPortalTopMenuInfo param = this.service.FindOne(id);

            outString.Append("{\"ajaxStorage\":" + AjaxStorageConvertor.Parse<NavigationPortalTopMenuInfo>(param) + ",");
        ...
        public string FindAll(XmlDocument doc)
        {
            ...
            IList<NavigationPortalTopMenuInfo> list = this.service.FindAll(whereClause, length);

            outString.Append("{\"ajaxStorage\":" + AjaxStorageConvertor.Parse<NavigationPortalTopMenuInfo>(list) + ",");
        ...
        public string GetPages(XmlDocument doc)
        {
            ...
            IList<NavigationPortalTopMenuInfo> list = this.service.GetPages(pages.RowIndex, pages.PageSize, pages.WhereClause, pages.OrderBy, out rowCount);
