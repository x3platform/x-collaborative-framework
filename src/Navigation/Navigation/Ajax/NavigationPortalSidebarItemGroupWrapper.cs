...
namespace X3Platform.Navigation.Ajax
{
    ...
    public class NavigationPortalSidebarItemGroupWrapper : ContextWrapper
    {
        ...
        public string Save(XmlDocument doc)
        {
            ...
            param = (NavigationPortalSidebarItemGroupInfo)AjaxStorageConvertor.Deserialize(param, doc);
        ...
        public string FindOne(XmlDocument doc)
        {
            ...
            outString.Append("{\"ajaxStorage\":" + AjaxStorageConvertor.Parse<NavigationPortalSidebarItemGroupInfo>(param) + ",");
        ...
        public string FindAll(XmlDocument doc)
        {
            ...
            outString.Append("{\"ajaxStorage\":" + AjaxStorageConvertor.Parse<NavigationPortalSidebarItemGroupInfo>(list) + ",");
