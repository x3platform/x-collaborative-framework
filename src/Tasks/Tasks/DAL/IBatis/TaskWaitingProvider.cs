namespace X3Platform.Tasks.DAL.IBatis
{
    ...
    /// <summary></summary>
    [DataObject]
    public class TaskWaitingProvider : ITaskWaitingProvider
    {
        /// <summary>配置</summary>
        ...
        private string tableName = "tb_TaskWaiting";

        /// <summary></summary>
        public TaskWaitingProvider()
        {
        ...
        #region 函数:Insert(TimingTaskWaitingInfo param)
        ...
        #region 函数:Update(TaskWaitingInfo param)
        ...
        public TaskWaitingInfo FindOneByTaskCode(string applicationId, string taskCode)
        {
            ...
            TaskWaitingInfo param = this.ibatisMapper.QueryForObject<TaskWaitingInfo>(StringHelper.ToProcedurePrefix(string.Format("{0}_FindOneByTaskCode", tableName)), args);
