namespace X3Platform.Tasks.DAL.SQLServer
{
    ...
    /// <summary></summary>
    [DataObject]
    public class TaskReceiverProvider : ITaskReceiverProvider
    {
        /// <summary>配置</summary>
        ...
        public void SetFinished(string receiverId, string taskIds)
        {
            ...
            args.Add("WhereClause", string.Format(" Status = 0 AND ReceiverId = '{0}' AND TaskId IN ({1}) ", receiverId, taskIds));
