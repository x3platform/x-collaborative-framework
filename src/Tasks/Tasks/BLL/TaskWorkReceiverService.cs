namespace X3Platform.Tasks.BLL
{
    ...
    public class TaskWorkReceiverService : ITaskWorkReceiverService
    {
        ...
        public TaskWorkReceiverService()
        {
            ...
            // 创建数据提供器
            this.provider = objectBuilder.GetObject<ITaskWorkReceiverProvider>(typeof(ITaskWorkReceiverProvider));
        }
        #endregion
