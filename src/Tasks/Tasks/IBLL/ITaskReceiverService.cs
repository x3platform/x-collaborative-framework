...
namespace X3Platform.Tasks.IBLL
{
    ...
    [SpringObject("X3Platform.Tasks.IBLL.ITaskReceiverService")]
    public interface ITaskReceiverService
    {
        ...
        IList<TaskWorkItemInfo> GetPages(string receiverId, int startIndex, int pageSize, string whereClause, string orderBy, out int rowCount);
        #endregion
