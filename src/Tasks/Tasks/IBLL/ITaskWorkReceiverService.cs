namespace X3Platform.Tasks.IBLL
{
    ...
    /// <summary>任务接收服务接口</summary>
    [SpringObject("X3Platform.Tasks.IBLL.ITaskWorkReceiverService")]
    public interface ITaskWorkReceiverService
    {
        ...
        #region 函数:GetPaging(string receiverId, int startIndex, int pageSize, DataQuery query, out int rowCount)
        ...
        IList<TaskWorkItemInfo> GetPaging(string receiverId, int startIndex, int pageSize, DataQuery query, out int rowCount);
        #endregion
        ...
        /// <param name="receiverId">接收者</param>
        /// <param name="taskIds">任务标识,多个以逗号分开</param>
        ...
        IList<TaskWorkItemInfo> GetWidgetData(string receiverId, int length);
        #endregion
    }
}
