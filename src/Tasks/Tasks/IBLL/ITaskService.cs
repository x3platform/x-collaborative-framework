...
namespace X3Platform.Tasks.IBLL
{
    ...
    public interface ITaskService
    {
        ...
        ///<returns>返回所有 AuthorityInfo 实例的详细信息</returns>
        IList<TaskInfo> FindAll(string whereClause);
        #endregion
        ...
        IList<TaskInfo> FindAll(string whereClause, int length);
        #endregion
        ...
        IList<TaskInfo> GetPages(int startIndex, int pageSize, string whereClause, string orderBy, out int rowCount);
        #endregion
