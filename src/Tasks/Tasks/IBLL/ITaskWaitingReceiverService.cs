namespace X3Platform.Tasks.IBLL
{
    ...
    [SpringObject("X3Platform.Tasks.IBLL.ITaskWaitingReceiverService")]
    public interface ITaskWaitingReceiverService
    {
        ...
        IList<TaskWaitingItemInfo> GetPaging(string receiverId, int startIndex, int pageSize, string whereClause, string orderBy, out int rowCount);
        #endregion
