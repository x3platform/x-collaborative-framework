namespace X3Platform.Tasks.Model
{
    ...
    public class TimingTaskInfo
    {
        ...
        /// <summary></summary>
        public TimingTaskInfo(string applicationId)
            : this()
        {
        ...
        private IList<TimingTaskReceiverInfo> m_ReceiverGroup = null;

        /// <summary>接收者</summary>
        public IList<TimingTaskReceiverInfo> ReceiverGroup
        {
            get
            {
                if (m_ReceiverGroup == null)
                {
                    m_ReceiverGroup = new List<TimingTaskReceiverInfo>();
                }
        ...
        public IList<TaskWaitingItemInfo> GetTaskWaitingItems()
        {
            ...
            foreach (TimingTaskReceiverInfo receiver in this.ReceiverGroup)
            {
