namespace X3Platform.Tasks.Model
{
    ...
    [Serializable]
    public class TaskWaitingReceiverInfo
    {
        /// <summary></summary>
        public TaskWaitingReceiverInfo()
        {
            this.m_SendTime = new DateTime(2000, 1, 1);
        }

        /// <summary></summary>
        public TaskWaitingReceiverInfo(string timingTaskId, string receiverId)
            : this()
        {
            this.m_TaskWaitingId = timingTaskId;
            this.m_ReceiverId = receiverId;
        }

        #region 属性:TaskWaitingId
        private string m_TaskWaitingId;

        /// <summary></summary>
        public string TaskWaitingId
        {
            get { return m_TaskWaitingId; }
            set { m_TaskWaitingId = value; }
        }
        #endregion

        private TaskWaitingInfo m_TaskWaiting;

        /// <summary>任务</summary>
        public TaskWaitingInfo TaskWaiting
        {
            get { return m_TaskWaiting; }
            set { m_TaskWaiting = value; }
        }
