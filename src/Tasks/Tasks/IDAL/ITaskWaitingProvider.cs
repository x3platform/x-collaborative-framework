namespace X3Platform.Tasks.IDAL
{
    ...
    /// <summary></summary>
    [SpringObject("X3Platform.Tasks.IDAL.ITaskWaitingProvider")]
    public interface ITaskWaitingProvider
    {
        // -------------------------------------------------------
        // 保存 添加 修改 删除
        // -------------------------------------------------------
        ...
        #region 函数:Insert(TaskWaitingInfo param)
        /// <summary>添加记录</summary>
        /// <param name="param">TaskWaitingInfo 实例的详细信息</param>
        void Insert(TaskWaitingInfo param);
        #endregion

        #region 函数:Update(TaskWaitingInfo param)
        /// <summary>修改记录</summary>
        /// <param name="param">TaskWaitingInfo 实例的详细信息</param>
        void Update(TaskWaitingInfo param);
        #endregion
