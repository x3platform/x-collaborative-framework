namespace X3Platform.Tasks.IDAL
{
    ...
    /// <summary></summary>
    [SpringObject("X3Platform.Tasks.IDAL.ITaskWorkProvider")]
    public interface ITaskWorkProvider
    {
        // -------------------------------------------------------
        // 保存 添加 修改 删除
        // -------------------------------------------------------
        ...
        void Insert(TaskWorkInfo param);
        #endregion

        #region 函数:Update(TaskWorkInfo param)
        /// <summary>修改记录</summary>
        /// <param name="param">TaskWorkInfo 实例的详细信息</param>
        void Update(TaskWorkInfo param);
        #endregion
        ...
        IList<TaskWorkItemInfo> GetPaging(int startIndex, int pageSize, string whereClause, string orderBy, out int rowCount);
        #endregion
