namespace X3Platform.Tasks.ServiceObservers
{
    ...
    /// <summary></summary>
    public sealed class TaskWorkItemServiceObserver : IServiceObserver
    {
        #region 属性:Name
        ...
        /// <summary></summary>
        public TaskWorkItemServiceObserver()
            : this("TaskWorkItem", string.Empty)
        {
        }

        /// <summary></summary>
        public TaskWorkItemServiceObserver(string name, string args)
        {
            this.m_Name = name;
