namespace X3Platform.Tasks.DAL.SQLServer
{
    ...
    /// <summary></summary>
    [DataObject]
    public class TaskProvider : ITaskWorkProvider
    {
        ...
        #region 函数:Insert(TaskWorkInfo param)
        ...
        #region 函数:Update(TaskWorkInfo param)
        ...
        public TaskWorkInfo FindOne(string id)
        {
            ...
            return this.ibatisMapper.QueryForObject<TaskWorkInfo>(StringHelper.ToProcedurePrefix(string.Format("{0}_FindOne", this.tableName)), args);
        }
        #endregion
        ...
        public TaskWorkInfo FindOneByTaskCode(string applicationId, string taskCode)
        {
            ...
            return this.ibatisMapper.QueryForObject<TaskWorkInfo>(StringHelper.ToProcedurePrefix(string.Format("{0}_FindOneByTaskCode", this.tableName)), args);
        }
        #endregion
