...
namespace X3Platform.Messages
{
    ...
    public class MessageObjectFormatter : IMessageObjectFormatter
    {
        /// <summary>消息格式化</summary>
        /// <param name="json">JSON 格式字符串</param>
        /// <param name="nobrace">对象不包含最外面的大括号</param>
        /// <returns>格式化后的字符串</returns>
        public string Format(string json, bool nobrace)
        {
            return nobrace ? json.Substring(1, json.Length - 2) : json;
        }
    }
}
