    ...
    public class GenericConnectionPlugin : IConnectionPlugin
    {
        ...
        public string ConnectionString
        {
            get
            {
                ...
                if (Provider == "MySql")
                {
                    return string.Concat("server=", DataSource, ((string.IsNullOrEmpty(Port) || Port == "3306") ? "" : ";port=" + Port),
                        ";database=", Database,
                        ";uid=", LoginName,
                        ";pwd=", Password,
                        ";pooling=", Pooling,
                ...
                {
                    return string.Concat("server=", DataSource, ((string.IsNullOrEmpty(Port) || Port == "1433") ? "" : "," + Port),
                        ";database=", Database,
                        ";user id=", LoginName,
                        ";password=", Password,
                        ";connection reset=", ConnectionReset,
