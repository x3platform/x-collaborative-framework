...
var ignoreFiles = ['README.md', 'change-marks.js', '.config', '.build', '.csproj'],
    ignoreDirectories = ['temp', 'bin', 'obj', 'Properties',
     'Collections', 'CommandLine', 'DynamicProxy', 'IBatis', 'Json', 'Logging', 'Yaml'];

// 需要修改的标记
var marks = [
{
    before: '// Copyright (c) 2010 Elane, ruany@chinasic.com',
    after: '// Copyright (c) 2010, ruany@live.com'
}];
