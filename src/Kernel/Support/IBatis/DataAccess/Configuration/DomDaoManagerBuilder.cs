...
using X3Platform.IBatis.DataAccess.Configuration.Serializers;
...
namespace X3Platform.IBatis.DataAccess.Configuration
{
    /// <summary>
    ...
    public class DomDaoManagerBuilder
    {
        ...
        public void BuildDaoManagers(XmlDocument document, bool useConfigFileWatcher)
        {
            ...
            {
                throw new X3Platform.IBatis.Common.Exceptions.ConfigurationException(configurationScope.ErrorContext.ToString(), ex);
            }
        }
