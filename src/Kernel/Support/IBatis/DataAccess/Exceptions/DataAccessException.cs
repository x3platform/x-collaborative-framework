...
namespace X3Platform.IBatis.DataAccess.Exceptions
{
	/// <summary>
	/// The DataAccessException is thrown when an error in the Dao occurs.
	/// </summary>
	[Serializable]
	public class DataAccessException : IBatisException
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="X3Platform.IBatis.DataAccess.Exceptions.DataAccessException"/> class.
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="X3Platform.IBatis.DataAccess.Exceptions.DataAccessException"/> 
