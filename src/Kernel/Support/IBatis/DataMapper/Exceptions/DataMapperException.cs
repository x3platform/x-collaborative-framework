...
namespace X3Platform.IBatis.DataMapper.Exceptions
{
	/// <summary>
	...
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="X3Platform.IBatis.DataMapper.Exceptions.DataMapperException"/> class.
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="X3Platform.IBatis.DataMapper.Exceptions.DataMapperException"/> 
