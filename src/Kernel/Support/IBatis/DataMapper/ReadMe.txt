...
If you only use the Dao API, add a reference to the X3Platform.IBatis.DataAccess.dll, 
X3Platform.IBatis.Common.dll in your own projects.

If you only use the Dao API with DataMapper API, add a reference to the X3Platform.IBatis.DataAccess.dll, 
X3Platform.IBatis.DataMapper.dll,X3Platform.IBatis.Common.dll in your own projects.

If you only use DataMapper API, add a reference to the X3Platform.IBatis.DataMapper.dll, 
X3Platform.IBatis.Common.dll in your own projects.
...
CONTRIBUTORS
  ...
  X3Platform.IBatis was originally created by Gilles Bayon. 
