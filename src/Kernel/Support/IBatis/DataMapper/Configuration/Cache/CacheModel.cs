...
namespace X3Platform.IBatis.DataMapper.Configuration.Cache
{
	...
	public class CacheModel
	{
		...
		public void Initialize() 
		{
			...
			{
				throw new X3Platform.IBatis.Common.Exceptions.ConfigurationException("Error instantiating cache controller for cache named '"+_id+". Cause: " + e.Message, e);
			}
			...
			{
				throw new X3Platform.IBatis.Common.Exceptions.ConfigurationException ("Error configuring controller named '"+_id+"'. Cause: " + e.Message, e);
			}
			finally
			{
