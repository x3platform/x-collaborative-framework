...
namespace X3Platform.IBatis.Common.Exceptions
{
	...
	public class ConfigurationException : IBatisException
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="X3Platform.IBatis.Common.Exceptions.ConfigurationException"/> class.
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="X3Platform.IBatis.Common.Exceptions.ConfigurationException"/> 
