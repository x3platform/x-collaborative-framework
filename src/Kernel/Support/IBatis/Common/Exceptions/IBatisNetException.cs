...
namespace X3Platform.IBatis.Common.Exceptions
{
	/// <summary>
	...
	/// </remarks>
	[Serializable]
	public class IBatisException : System.ApplicationException
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="X3Platform.IBatis.Common.Exceptions.IBatisException"/> class.
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="X3Platform.IBatis.Common.Exceptions.IBatisException"/> 
