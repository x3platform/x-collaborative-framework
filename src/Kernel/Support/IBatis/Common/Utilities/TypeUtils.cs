...
using X3Platform.IBatis.Common.Utilities.TypesResolver;

namespace X3Platform.IBatis.Common.Utilities
{
    /// <summary>
    ...
    public sealed class TypeUtils
    {
		...
		/// <summary>
        /// Creates a new instance of the <see cref="X3Platform.IBatis.Common.Utilities.TypeUtils"/> class.
		/// </summary>
		/// <remarks>
		/// <p>
