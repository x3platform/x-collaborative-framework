...
namespace X3Platform.Logging.Core
{
    ...
    public class LogImpl : LoggerWrapperImpl, IInternalLog
    {
        ...
        /// <summary>
        /// Event handler for the <see cref="X3Platform.Logging.Repository.ILoggerRepository.ConfigurationChanged"/> event
        /// </summary>
