...
namespace X3Platform.Logging.Core
{
	...
	/// </para>
	/// <para>
	/// The levels that are recognized by X3Platform.Logging are set for each <see cref="X3Platform.Logging.Repository.ILoggerRepository"/>
	/// and each repository can have different levels defined. The levels are stored
	/// in the <see cref="X3Platform.Logging.Repository.ILoggerRepository.LevelMap"/> on the repository. Levels are
	/// looked up by name from the <see cref="X3Platform.Logging.Repository.ILoggerRepository.LevelMap"/>.
	/// </para>
	/// <para>
	...
	sealed public class Level : IComparable
	{
        ...
        /// </summary>
        public readonly static Level Log4Net_Debug = new Level(120000, "X3Platform.Logging:DEBUG");
