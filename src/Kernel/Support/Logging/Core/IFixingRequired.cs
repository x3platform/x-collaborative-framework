...
namespace X3Platform.Logging.Core
{
	...
	/// <see cref="X3Platform.Logging.Appender.IAppender.DoAppend"/> method.
	/// </para>
	/// <para>
	/// When objects that implement this interface are stored 
	/// in the context properties maps <see cref="X3Platform.Logging.GlobalContext"/>
	/// <see cref="X3Platform.Logging.GlobalContext.Properties"/> and <see cref="X3Platform.Logging.ThreadContext"/>
	/// <see cref="X3Platform.Logging.ThreadContext.Properties"/> are fixed 
