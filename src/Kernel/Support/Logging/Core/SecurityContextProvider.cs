...
namespace X3Platform.Logging.Core
{
	...
	/// </para>
	/// <para>
	/// An alternative is to use the <c>X3Platform.Logging.Config.SecurityContextProviderAttribute</c>
	/// This attribute can be applied to an assembly in the same way as the
	/// <c>X3Platform.Logging.Config.XmlConfiguratorAttribute"</c>. The attribute takes
