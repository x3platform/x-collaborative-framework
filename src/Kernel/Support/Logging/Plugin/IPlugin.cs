...
namespace X3Platform.Logging.Plugin
{
	...
	/// with a <see cref="X3Platform.Logging.Repository.ILoggerRepository"/>.
	/// The <see cref="PluginMap"/> held by the <see cref="X3Platform.Logging.Repository.ILoggerRepository.PluginMap"/>
	/// property is used to store the plugins for a repository.
	/// </para>
	/// <para>
	/// The <c>X3Platform.Logging.Config.PluginAttribute</c> can be used to
