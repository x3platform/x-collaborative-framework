...
using IRemoteLoggingSink = X3Platform.Logging.Appender.RemotingAppender.IRemoteLoggingSink;

namespace X3Platform.Logging.Plugin
{
	/// <summary>
	/// Plugin that listens for events from the <see cref="X3Platform.Logging.Appender.RemotingAppender"/>
	/// </summary>
	/// <remarks>
	/// <para>
	...
	/// a remote <see cref="X3Platform.Logging.Appender.RemotingAppender"/>.
	/// </para>
	/// <para>
