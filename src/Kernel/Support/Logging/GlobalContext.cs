...
{
    /// <summary>
    /// The X3Platform.Logging Global Context.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// be included in the output of log messages. The <see cref="X3Platform.Logging.Layout.PatternLayout"/>
    /// supports selecting and outputing these properties.
    /// </para>
    /// <para>
    /// By default the <c>X3Platform.Logging:HostName</c> property is set to the name of 
    /// the current machine.
    /// </para>
    /// </remarks>
    /// <example>
