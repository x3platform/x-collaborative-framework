...
namespace X3Platform.Logging.Layout
{
	...
	/// X3Platform.Logging:event elements. It does not output a complete well-formed XML 
	...
	/// &lt;?xml version="1.0" ?&gt;
	/// 
	/// &lt;!DOCTYPE X3Platform.Logging:events SYSTEM "X3Platform.Logging-events.dtd" [&lt;!ENTITY data SYSTEM "abc"&gt;]&gt;
	///
	/// &lt;X3Platform.Logging:events version="1.2" xmlns:X3Platform.Logging="http://logging.apache.org/X3Platform.Logging/schemas/X3Platform.Logging-events-1.2&gt;
	///     &amp;data;
	/// &lt;/X3Platform.Logging:events&gt;
	/// </code>
	/// <para>
	...
	public class XmlLayout : XmlLayoutBase
	{
		...
		/// <remarks>
		/// <para>
		/// The default prefix is <b>X3Platform.Logging</b>. Set this property
