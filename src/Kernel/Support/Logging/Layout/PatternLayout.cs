...
namespace X3Platform.Logging.Layout
{
	...
	/// that the X3Platform.Logging environment was set to use a PatternLayout. Then the
	/// statements
	/// </para>
	/// <code lang="C#">
	...
	/// 			</para>
	/// 			<para>
	/// 			For example, for the class name "X3Platform.Logging.Layout.PatternLayout", the
