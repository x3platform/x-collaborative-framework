...
namespace X3Platform.Logging.Appender
{
	...
	/// </code>
	/// <para>
	/// The Level is the standard X3Platform.Logging logging level and ForeColor and BackColor can be any
	...
	public class ColoredConsoleAppender : AppenderSkeleton
	{
		...
		/// <summary>
		/// This method is called by the <see cref="AppenderSkeleton.DoAppend(X3Platform.Logging.Core.LoggingEvent)"/> method.
		/// </summary>
