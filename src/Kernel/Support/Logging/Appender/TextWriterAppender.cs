...
namespace X3Platform.Logging.Appender
{
	...
	public class TextWriterAppender : AppenderSkeleton
	{
		...
		/// <summary>
		/// Gets or sets the <see cref="X3Platform.Logging.Util.QuietTextWriter"/> where logging events
		/// will be written to. 
		/// </summary>
		/// <value>
		/// The <see cref="X3Platform.Logging.Util.QuietTextWriter"/> where logging events are written.
		/// </value>
		/// <remarks>
		/// <para>
		/// This is the <see cref="X3Platform.Logging.Util.QuietTextWriter"/> where logging events
		/// will be written to. 
		/// </para>
		/// </remarks>
