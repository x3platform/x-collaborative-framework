...
namespace X3Platform.Logging.Appender 
{
	...
	/// <appender name="UdpAppender" type="X3Platform.Logging.Appender.UdpAppender">
	///     <remoteAddress value="224.0.0.1" />
	///     <remotePort value="8080" />
	///     <layout type="X3Platform.Logging.Layout.PatternLayout" value="%-5level %logger [%ndc] - %message%newline" />
	/// </appender>
	/// </code>
	/// </example>
	...
	public class UdpAppender : AppenderSkeleton
	{
		...
		public int RemotePort
		{
			...
			set 
			{
				...
				{
					throw SystemInfo.CreateArgumentOutOfRangeException("value", (object)value,
		...
		public override void ActivateOptions()
		{
			...
			{
				throw SystemInfo.CreateArgumentOutOfRangeException("this.RemotePort", (object)this.RemotePort,
			...
			{
				throw SystemInfo.CreateArgumentOutOfRangeException("this.LocalPort", (object)this.LocalPort,
