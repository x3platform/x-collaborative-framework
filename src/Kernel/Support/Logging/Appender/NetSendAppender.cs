...
namespace X3Platform.Logging.Appender 
{
	...
	/// <appender name="NetSendAppender_Operator" type="X3Platform.Logging.Appender.NetSendAppender">
	///     <server value="LOCAL_PC" />
	///     <recipient value="OPERATOR_PC" />
	///     <layout type="X3Platform.Logging.Layout.PatternLayout" value="%-5p %c [%x] - %m%n" />
	/// </appender>
	/// </code>
	/// </example>
