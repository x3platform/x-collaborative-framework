...
namespace X3Platform.Logging.Appender
{
    ...
    /// See also http://logging.apache.org/X3Platform.Logging/release/faq.html#trouble-EventLog
    /// </para>
    /// <para>
    ...
    /// </code>
    /// <para>
    /// The Level is the standard X3Platform.Logging logging level and eventLogEntryType can be any value
        ...
        override public void ActivateOptions()
        {
            ...
            catch (System.Security.SecurityException ex)
            {
                ErrorHandler.Error("Caught a SecurityException trying to access the EventLog.  Most likely the event source "
                    ...
                    + "  See http://logging.apache.org/X3Platform.Logging/release/faq.html#trouble-EventLog",
                    ex);
                Threshold = Level.Off;
            }
        }
