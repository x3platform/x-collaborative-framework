...
namespace X3Platform.Logging.Appender 
{
	...
	public class LocalSyslogAppender : AppenderSkeleton 
	{
		...
		/// <remarks>
		/// <para>
		/// The X3Platform.Logging Level maps to a syslog severity using the
		...
		/// <summary>
		/// Translates a X3Platform.Logging level to a syslog severity.
		/// </summary>
		/// <param name="level">A X3Platform.Logging level.</param>
