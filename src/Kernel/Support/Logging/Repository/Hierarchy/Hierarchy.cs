...
namespace X3Platform.Logging.Repository.Hierarchy
{
    ...
    public class Hierarchy : LoggerRepositorySkeleton, IBasicRepositoryConfigurator, IXmlRepositoryConfigurator
    {
        ...
        /// </para>
        /// </remarks>
        override public IAppender[] GetAppenders()
        {
        ...
        private static void CollectAppender(System.Collections.ArrayList appenderList, IAppender appender)
        {
        ...
        /// <summary>
        /// Initialize the X3Platform.Logging system using the specified appender
        /// </summary>
        ...
        /// <summary>
        /// Initialize the X3Platform.Logging system using the specified appenders
        /// </summary>
        ...
        /// <summary>
        /// Initialize the X3Platform.Logging system using the specified config
        /// </summary>
