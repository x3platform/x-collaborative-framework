...
namespace X3Platform.Logging.Repository.Hierarchy
{
    ...
    /// </para>
    /// <para>
    /// This is one of the central classes in the X3Platform.Logging implementation. One of the
    /// distinctive features of X3Platform.Logging are hierarchical loggers and their
    ...
    public abstract class Logger : IAppenderAttachable, ILogger
    {
        ...
        virtual public void Log(Type callerStackBoundaryDeclaringType, Level level, object message, Exception exception)
        {
            ...
            {
               ¡¡LogLog.Error(declaringType, "Exception while logging");
            }
#endif
        }
        ...
        virtual protected void CallAppenders(LoggingEvent loggingEvent)
        {
            ...
            if (!m_hierarchy.EmittedNoAppenderWarning && writes == 0)
            {
                ...
                LogLog.Debug(declaringType, "Please initialize the X3Platform.Logging system properly.");
                try
                {
