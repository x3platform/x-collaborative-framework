...
namespace X3Platform.Logging.ObjectRenderer
{
    /// <summary>
            ...
            else
            {
                ...
                else
                {
                    ...
                    catch (Exception ex)
                    {
                        ...
                        writer.Write("<X3Platform.Logging.Error>Exception rendering object type [" + objectTypeName + "]");
                        if (ex != null)
                        {
                        ...
                        writer.Write("</X3Platform.Logging.Error>");
                    }
                }
            }
        }
