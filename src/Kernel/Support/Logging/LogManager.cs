...
namespace X3Platform.Logging
{
	...
	public sealed class LogManager
	{
        ...
        public static IInternalLog Exists(string name) 
		{
		...
		/// </returns>
        public static IInternalLog Exists(Assembly repositoryAssembly, string name) 
		{
        ...
        public static IInternalLog[] GetCurrentLoggers()
		{
		...
		/// </remarks>
		/// <returns>All the defined loggers.</returns>
        public static IInternalLog[] GetCurrentLoggers(string repository)
		{
		...
		/// </remarks>
		/// <returns>All the defined loggers.</returns>
        public static IInternalLog[] GetCurrentLoggers(Assembly repositoryAssembly)
		{
        ...
        public static IInternalLog GetLogger(string name)
		{
		...
		/// <param name="name">The name of the logger to retrieve.</param>
		/// <returns>The logger with the name specified.</returns>
        public static IInternalLog GetLogger(string repository, string name)
		{
		...
		/// <param name="name">The name of the logger to retrieve.</param>
		/// <returns>The logger with the name specified.</returns>
        public static IInternalLog GetLogger(Assembly repositoryAssembly, string name)
		{
		...
		/// <returns>The logger with the name specified.</returns>
        public static IInternalLog GetLogger(Type type) 
		{
		...
		/// <param name="type">The full name of <paramref name="type"/> will be used as the name of the logger to retrieve.</param>
		/// <returns>The logger with the name specified.</returns>
        public static IInternalLog GetLogger(string repository, Type type) 
		{
		...
		/// <param name="type">The full name of <paramref name="type"/> will be used as the name of the logger to retrieve.</param>
		/// <returns>The logger with the name specified.</returns>
        public static IInternalLog GetLogger(Assembly repositoryAssembly, Type type) 
		{
		...
		/// <summary>
		/// Shuts down the X3Platform.Logging system.
		/// </summary>
		/// <remarks>
		/// <para>
		...
		/// <see cref="X3Platform.Logging.Repository.Hierarchy.Hierarchy"/> object.
		/// </para>
		/// <para>
        ...
        private static IInternalLog WrapLogger(ILogger logger)
		{
            return (IInternalLog)s_wrapperMap.GetWrapper(logger);
		}
        ...
        private static IInternalLog[] WrapLoggers(ILogger[] loggers)
		{
            IInternalLog[] results = new IInternalLog[loggers.Length];
