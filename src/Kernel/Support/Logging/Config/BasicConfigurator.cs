...
namespace X3Platform.Logging.Config
{
    ...
    /// <remarks>
    /// <para>
    /// Allows very simple programmatic configuration of X3Platform.Logging.
    /// </para>
    /// <para>
    ...
    /// </para>
    /// <para>
    /// Appenders can also implement the <see cref="X3Platform.Logging.Core.IOptionHandler"/> interface. Therefore
    /// they would require that the <see cref="M:X3Platform.Logging.Core.IOptionHandler.ActivateOptions()"/> method
    ...
    public sealed class BasicConfigurator
    {
        ...
        /// <summary>
        /// Initializes the X3Platform.Logging system with a default configuration.
        /// </summary>
        /// <remarks>
        /// <para>
        /// Initializes the X3Platform.Logging logging system using a <see cref="ConsoleAppender"/>
        ...
        /// <summary>
        /// Initializes the X3Platform.Logging system using the specified appender.
        /// </summary>
        ...
        /// <summary>
        /// Initializes the X3Platform.Logging system using the specified appenders.
        /// </summary>
