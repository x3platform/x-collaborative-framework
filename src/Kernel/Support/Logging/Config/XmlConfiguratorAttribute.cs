...
namespace X3Platform.Logging.Config
{
    ...
    /// When using the X3Platform.Logging assembly level attributes to control the configuration 
    /// of X3Platform.Logging you must ensure that the first call to any of the 
    /// <see cref="X3Platform.Logging.Core.LoggerManager"/> methods is made from the assembly with the configuration
    /// attributes. 
    /// </para>
    /// <para>
    /// If you cannot guarantee the order in which X3Platform.Logging calls will be made from 
