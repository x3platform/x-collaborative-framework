...
namespace X3Platform.Logging.Config
{
    /// <summary>
    /// Use this class to initialize the X3Platform.Logging environment using an Xml tree.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    public sealed class XmlConfigurator
    {
...
#if !NETCF
        /// <summary>
        /// Automatically configures the X3Platform.Logging system based on the 
        ...
        /// <c>X3Platform.Logging</c> that contains the configuration data.
        /// </para>
        /// <para>
        /// To use this method to configure X3Platform.Logging you must specify 
        /// the <see cref="LoggingConfigurationSectionHandler"/> section
        /// handler for the <c>X3Platform.Logging</c> configuration section. See the
        /// <see cref="LoggingConfigurationSectionHandler"/> for an example.
        /// </para>
        /// </remarks>
        /// <seealso cref="LoggingConfigurationSectionHandler"/>
#else
		/// <summary>
		/// Automatically configures the X3Platform.Logging system based on the 
		/// application's configuration settings.
        ...
        static private void InternalConfigure(ILoggerRepository repository)
        {
...
#if NET_2_0
				configElement = System.Configuration.ConfigurationManager.GetSection("logging") as XmlElement;
#else
                configElement = System.Configuration.ConfigurationSettings.GetConfig("logging") as XmlElement;
#endif
                if (configElement == null)
                {
                    // Failed to load the xml config using configuration settings handler
                    LogLog.Error(declaringType, "Failed to find configuration section 'X3Platform.Logging' in the application's .config file. Check your .config file for the <X3Platform.Logging> and <configSections> elements. The configuration section should look like: <section name=\"X3Platform.Logging\" type=\"X3Platform.Logging.Config.LoggingConfigurationSectionHandler,X3Platform.Logging\" />");
                }
                else
                {
            ...
            catch (System.Configuration.ConfigurationException confEx)
            {
                ...
                else
                {
                    ...
                    string configSectionStr = "<section name=\"X3Platform.Logging\" type=\"X3Platform.Logging.Config.LoggingConfigurationSectionHandler," + Assembly.GetExecutingAssembly().FullName + "\" />";
        ...
        /// <summary>
        /// Configures X3Platform.Logging using a <c>X3Platform.Logging</c> element
        /// </summary>
        /// <remarks>
        /// <para>
        /// Loads the X3Platform.Logging configuration from the XML element
...
#if !NETCF
        /// <summary>
        /// Configures X3Platform.Logging using the specified configuration file.
        /// </summary>
        /// <param name="configFile">The XML file to load the configuration from.</param>
        /// <remarks>
        /// <para>
        /// The configuration file must be valid XML. It must contain
        /// at least one element called <c>X3Platform.Logging</c> that holds
        /// the X3Platform.Logging configuration data.
        /// </para>
        /// <para>
        /// The X3Platform.Logging configuration file can possible be specified in the application's
        ...
        /// a configuration section for the <c>X3Platform.Logging</c> element otherwise .NET will 
        /// complain. Set the type for the section handler to <see cref="System.Configuration.IgnoreSectionHandler"/>, for example:
        /// <code lang="XML" escaped="true">
        /// <configSections>
        ///		<section name="logging" type="System.Configuration.IgnoreSectionHandler" />
        ///	</configSections>
        /// </code>
        /// </para>
        /// <example>
        /// The following example configures X3Platform.Logging using a configuration file, of which the 
        ...
        /// ...
        /// 
        /// XmlConfigurator.Configure(new FileInfo(ConfigurationSettings.AppSettings["X3Platform.Logging-config-file"]));
        /// </code>
        /// <para>
        /// In the <c>.config</c> file, the path to the X3Platform.Logging can be specified like this :
        /// </para>
        /// <code lang="XML" escaped="true">
        /// <configuration>
        ///		<appSettings>
        ///			<add key="X3Platform.Logging-config-file" value="log.config"/>
        ///		</appSettings>
        ///	</configuration>
        /// </code>
        /// </remarks>
        ...
        /// <summary>
        /// Configures X3Platform.Logging using the specified configuration URI.
        /// </summary>
        ...
        /// <summary>
        /// Configures X3Platform.Logging using the specified configuration data stream.
        /// </summary>
        ...
        static private void InternalConfigure(ILoggerRepository repository, Stream configStream)
        {
            ...
            else
            {
                ...
                if (doc != null)
                {
                    ...
                    // Configure using the 'X3Platform.Logging' element
                    XmlNodeList configNodeList = doc.GetElementsByTagName("logging");
                    if (configNodeList.Count == 0)
                    {
                        LogLog.Debug(declaringType, "XML configuration does not contain a <X3Platform.Logging> element. Configuration Aborted.");
                    }
                    else if (configNodeList.Count > 1)
                    {
                        LogLog.Error(declaringType, "XML configuration contains [" + configNodeList.Count + "] <X3Platform.Logging> elements. Only one is allowed. Configuration Aborted.");
                    }
                    else
                    {
        ...
        /// <summary>
        /// Configures X3Platform.Logging using the file specified, monitors the file for changes 
        ...
        static private void InternalConfigureAndWatch(ILoggerRepository repository, FileInfo configFile)
        {
            ...
            {
                // Configure X3Platform.Logging now
                InternalConfigure(repository, configFile);
        ...
        /// <summary>
        /// Configures the specified repository using a <c>X3Platform.Logging</c> element.
        /// </summary>
