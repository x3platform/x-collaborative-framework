...
namespace X3Platform.Logging.Config
{
	...
	/// specifies the type of the <see cref="X3Platform.Logging.Repository.ILoggerRepository"/> object 
	...
	public /*sealed*/ class RepositoryAttribute : Attribute
	{
		...
		/// The type must implement the <see cref="X3Platform.Logging.Repository.ILoggerRepository"/>
		/// interface.
		/// </para>
		/// <para>
