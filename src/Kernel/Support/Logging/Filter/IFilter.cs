...
namespace X3Platform.Logging.Filter
{
	/// <summary>
	...
	/// event filtering. Note that <see cref="X3Platform.Logging.Repository.Hierarchy.Logger"/> and 
	/// <see cref="X3Platform.Logging.Appender.AppenderSkeleton"/>, the parent class of all standard
	...
	/// </para>
	/// <para>
	/// The philosophy of X3Platform.Logging filters is largely inspired from the
	/// Linux ipchains.
	/// </para>
	/// </remarks>
