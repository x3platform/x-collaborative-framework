...
{
	/// <summary>
	/// Implementation of Stack for the <see cref="X3Platform.Logging.ThreadContext"/>
	/// </summary>
	/// <remarks>
	/// <para>
	/// Implementation of Stack for the <see cref="X3Platform.Logging.ThreadContext"/>
	...
	public sealed class ThreadContextStack : IFixingRequired
	{
		...
		/// for example by using the <c>using(X3Platform.Logging.ThreadContext.Stacks["NDC"].Push("Stack_Message"))</c> 
		/// syntax.
		/// </para>
		/// </remarks>
		public void Clear() 
		...
		/// <code lang="C#">
		/// using(X3Platform.Logging.ThreadContext.Stacks["NDC"].Push("Stack_Message"))
		/// {
