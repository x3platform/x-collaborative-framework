...
namespace X3Platform.Logging.Util
{
    ...
    public sealed class SystemInfo
    {
        ...
        static SystemInfo()
        {
...
#if !NETCF
            // Look for X3Platform.Logging.NullText in AppSettings
            string nullTextAppSettingsKey = SystemInfo.GetAppSetting("X3Platform.Logging.NullText");
            ...
            // Look for X3Platform.Logging.NotAvailableText in AppSettings
            string notAvailableTextAppSettingsKey = SystemInfo.GetAppSetting("X3Platform.Logging.NotAvailableText");
        ...
        /// <remarks>
        /// <para>
        /// This is the time at which the X3Platform.Logging library was loaded into the
        /// AppDomain. Due to reports of a hang in the call to <c>System.Diagnostics.Process.StartTime</c>
        /// this is not the start time for the current process.
        /// </para>
        /// <para>
        /// The X3Platform.Logging library should be loaded by an application early during its
        ...
        /// a value for the <c>X3Platform.Logging.NullText</c> appSetting in the application's
        /// .config file.
        /// </para>
        /// </remarks>
        ...
        /// a value for the <c>X3Platform.Logging.NotAvailableText</c> appSetting in the application's
        /// .config file.
        /// </para>
        /// </remarks>
