...
namespace X3Platform.Logging.Util
{
    ...
    public sealed class LogLog
    {
        ...
        /// <remarks>
        /// "X3Platform.Logging: ", 
        /// "X3Platform.Logging:ERROR ", 
        /// "X3Platform.Logging:WARN "
        /// </remarks>
        ...
        static LogLog()
        {
            ...
            try
            {
                ...
                EmitInternalMessages = OptionConverter.ToBoolean(SystemInfo.GetAppSetting("X3Platform.Logging.Internal.Emit"), true);
            }
            catch (Exception ex)
            {
