...
namespace X3Platform.Logging.Util
{
	...
	/// </para>
	/// <para>
	/// This class functions similarly to the <see cref="X3Platform.Logging.Layout.PatternLayout"/>
	/// in that it accepts a pattern and renders it to a string. Unlike the 
	/// <see cref="X3Platform.Logging.Layout.PatternLayout"/> however the <c>PatternString</c>
	...
	/// 			assumed (<see cref="X3Platform.Logging.DateFormatter.Iso8601DateFormatter"/>).
	/// 			</para>
	/// 			<para>
	...
	/// 			<see cref="X3Platform.Logging.DateFormatter.AbsoluteTimeDateFormatter"/>, 
	/// 			<see cref="X3Platform.Logging.DateFormatter.DateTimeDateFormatter"/> and respectively 
	/// 			<see cref="X3Platform.Logging.DateFormatter.Iso8601DateFormatter"/>. For example, 
	...
	/// 			the <c>X3Platform.Logging:HostName</c> property is set to the name of machine on 
	...
	/// </para>
	/// <para>
	/// See the <see cref="X3Platform.Logging.Layout.PatternLayout"/> for details on the 
