...
{
	/// <summary>
	/// Implementation of Properties collection for the <see cref="X3Platform.Logging.LogicalThreadContext"/>
	/// </summary>
	/// <remarks>
	/// <para>
	...
	public sealed class LogicalThreadContextProperties : ContextPropertiesBase
	{
		...
		{
			PropertiesDictionary properties = (PropertiesDictionary)CallContext.GetData("X3Platform.Logging.Util.LogicalThreadContextProperties");
			if (properties == null && create)
			{
				properties  = new PropertiesDictionary();
				CallContext.SetData("X3Platform.Logging.Util.LogicalThreadContextProperties", properties);
			}
			return properties;
		}
