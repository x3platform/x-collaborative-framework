...
namespace X3Platform.Logging.Util
{
	...
	public static class ILogExtensions
	{
		...
		/// string by invoking the appropriate <see cref="X3Platform.Logging.ObjectRenderer.IObjectRenderer"/>.
		...
		public static void DebugExt(this ILog logger, Func<object> callback)
		{
			...
			{
				X3Platform.Logging.Util.LogLog.Error(declaringType, "Exception while logging", ex);
			}
		}
		...
		/// <see cref="X3Platform.Logging.ObjectRenderer.IObjectRenderer"/>. It then 
