...
namespace X3Platform.Logging.Util.PatternStringConverters
{
	...
	internal sealed class PropertyPatternConverter : PatternConverter 
	{
		...
		/// should be set in the <see cref="X3Platform.Logging.Util.PatternConverter.Option"/>
		/// property.
		/// </para>
		/// <para>
		/// If the <see cref="X3Platform.Logging.Util.PatternConverter.Option"/> is set to <c>null</c>
