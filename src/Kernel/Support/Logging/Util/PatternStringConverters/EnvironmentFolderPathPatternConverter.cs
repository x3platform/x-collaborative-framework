...
namespace X3Platform.Logging.Util.PatternStringConverters
{
    /// <summary>
    ...
    /// The value of the <see cref="X3Platform.Logging.Util.PatternConverter.Option"/> determines 
    /// the name of the variable to output. <see cref="X3Platform.Logging.Util.PatternConverter.Option"/>
    ...
    internal sealed class EnvironmentFolderPathPatternConverter : PatternConverter
    {
        ...
        /// using the <see cref="X3Platform.Logging.Util.PatternConverter.Option"/>
        /// property.
        /// </para>
        /// </remarks>
