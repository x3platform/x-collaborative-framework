...
namespace X3Platform.Tests.Configuration
{
    ...
    public class KernelConfigurationViewTestSuite
    {
        ...
        public void TestDeserialize()
        {
            ...
            KernelConfiguration configuration = (KernelConfiguration)ser.Deserialize(new XmlNodeReader(node));
        ...
        public void TestSave()
        {
            ...
            KernelConfigurationKey key1 = new KernelConfigurationKey("HostName", "http://www.x3platform.com");
