...
set TargetIBatisResourceDir=%SrcDir%WebSite\1.0.0\resources\ibatis\Membership\HumanResources\
...
@rem if exist "%TargetWebSiteDir%resources\ibatis\" call:CopyIBatisFiles
