...
{
    /// <summary></summary>
    [SpringObject("X3Platform.Membership.IBLL.IContactService")]
    public interface IContactService
    {
        ...
        IList<ContactInfo> GetPages(int startIndex, int pageSize, string whereClause, string orderBy, out int rowCount);
        #endregion
