...
namespace X3Platform.Membership.DAL.IBatis
{
    ...
    public class SettingProvider : ISettingProvider
    {
        ...
        public IList<SettingInfo> GetPaging(int startIndex, int pageSize, DataQuery query, out int rowCount)
        {
            Dictionary<string, object> args = new Dictionary<string, object>();
            ...
            IList<SettingInfo> list = ibatisMapper.QueryForList<SettingInfo>(StringHelper.ToProcedurePrefix(string.Format("{0}_GetPaging", tableName)), args);
