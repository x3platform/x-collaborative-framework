    ...
    public class GroupProvider : IGroupProvider
    {
        ...
        public void Delete(string id)
        {
            ...
            try
            {
                ...
                // 删除群组与帐号的关系
                this.RemoveRelation(string.Format(" GroupId = ##{0}## ", id));

                args.Add("WhereClause", string.Format(" Id IN ('{0}') ", id));
        ...
        {
            string whereClause = string.Format(" CatalogItemId = ##{0}##", CatalogItemId);
