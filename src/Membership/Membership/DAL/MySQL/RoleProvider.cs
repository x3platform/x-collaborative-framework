...
namespace X3Platform.Membership.DAL.MySQL
{
    ...
    public class RoleProvider : IRoleProvider
    {
        ...
        /// <param name="Id">IRoleInfo Id号</param>
        ...
        public IRoleInfo FindOne(string id)
        {
            ...
            RoleInfo param = ibatisMapper.QueryForObject<RoleInfo>(StringHelper.ToProcedurePrefix(string.Format("{0}_FindOne", tableName)), args);
        ...
        public IList<IRoleInfo> FindAll(string whereClause, int length)
        {
            ...
            IList<IRoleInfo> list = ibatisMapper.QueryForList<IRoleInfo>(StringHelper.ToProcedurePrefix(string.Format("{0}_FindAll", tableName)), args);
...
", organizationId, level);
        ...
        public IList<IRoleInfo> FindStandardGeneralRolesByOrganizationId(string organizationId, string standardGeneralRoleId)
        {
            ...
            whereClause += string.Format(@" AND Id IN ( SELECT RoleId FROM tb_StandardGeneralRole_Mapping WHERE StandardGeneralRoleId = ##{1}## ) ", standardGeneralRoleId);
        ...
        public IList<AuthorityInfo> GetAuthorities(string roleId)
        {
            ...
            IList<string> ids = ibatisMapper.QueryForList<string>(StringHelper.ToProcedurePrefix(string.Format("{0}_GetAuthorities", tableName)), args);
        ...
        private IList<IAccountRoleRelationInfo> FindAllRelation(string whereClause)
        {
            ...
            return ibatisMapper.QueryForList<IAccountRoleRelationInfo>(StringHelper.ToProcedurePrefix(string.Format("{0}_FindAllRelation", tableName)), args);
        }
        #endregion
