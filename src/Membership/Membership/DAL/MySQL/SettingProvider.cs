...
namespace X3Platform.Membership.DAL.MySQL
{
    ...
    public class SettingProvider : ISettingProvider
    {
        ...
        #region 属性:FindAllBySettingGroupId(string applicationSettingGroupId, string keyword)
        /// <summary>���ݲ���������Ϣ��ѯ�������ؼ�¼</summary>
        /// <param name="applicationSettingGroupId">����������ʶ</param>
        ...
        {
            string whereClause = string.Format(@" ApplicationSettingGroupId = ##{0}## AND Text LIKE ##%{1}%## ORDER BY OrderId, Text ", StringHelper.ToSafeSQL(applicationSettingGroupId), StringHelper.ToSafeSQL(keyword));
        ...
        #region 属性:FindAllBySettingGroupName(string applicationSettingGroupName, string keyword)
        /// <summary>���ݲ���������Ϣ��ѯ�������ؼ�¼</summary>
        ...
        {
            string whereClause = string.Format(@" ApplicationSettingGroupId = ( SELECT Id FROM `sys_config`.`tb_Application_SettingGroup` WHERE Name = ##{0}## ) AND Text LIKE ##%{1}%## ORDER BY OrderId, Text ", StringHelper.ToSafeSQL(applicationSettingGroupName), StringHelper.ToSafeSQL(keyword));

            if (string.IsNullOrEmpty(keyword))
            {
                whereClause = string.Format(@" ApplicationSettingGroupId = ( SELECT Id FROM `sys_config`.`tb_Application_SettingGroup` WHERE Name = ##{0}## ) ORDER BY OrderId, Text ", StringHelper.ToSafeSQL(applicationSettingGroupName));
            }
        ...
        /// <returns></returns>
        public string GetText(string applicationSettingGroupName, string value)
        {
            string whereClause = string.Format(@"
ApplicationId = ##{0}##
AND ApplicationSettingGroupId IN ( SELECT Id FROM `sys_config`.`tb_Application_SettingGroup` WHERE Name = ##{1}## )
AND Value = ##{2}##
", "00000000-0000-0000-0000-000000000100", StringHelper.ToSafeSQL(applicationSettingGroupName), StringHelper.ToSafeSQL(value));
        ...
        #region 属性:GetValue( string applicationSettingGroupName, string text)
        /// <summary>�������õ��ı���ȡֵ��Ϣ</summary>
        /// <param name="applicationId"></param>
        /// <param name="applicationSettingGroupName"></param>
        /// <param name="text"></param>
        /// <returns></returns>
        public string GetValue(string applicationSettingGroupName, string text)
        {
            string whereClause = string.Format(@"
ApplicationId = ##{0}##
AND ApplicationSettingGroupId IN ( SELECT Id FROM `sys_config`.`tb_Application_SettingGroup` WHERE Name = ##{1}## )
AND Text = ##{2}##
", "00000000-0000-0000-0000-000000000100", StringHelper.ToSafeSQL(applicationSettingGroupName), StringHelper.ToSafeSQL(text));
