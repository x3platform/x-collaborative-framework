...
namespace X3Platform.Membership.DAL.MySQL
{
    ...
    public class JobProvider : IJobProvider
    {
        ...
        //#region ˽�к���:BindRelation(IJobInfo param)
        ///// <summary>�󶨹�ϵ</summary>
        ///// <param name="param">IJobInfo ʵ������ϸ��Ϣ</param>
        //private void BindRelation(IJobInfo param)
        //{
        //    try
        //    {
        ...
        //        args.Add("JobId", param.Id);

        //        ibatisMapper.Delete(StringHelper.ToProcedurePrefix(string.Format("{0}_StandardRole_DeleteByJobId", tableName)), args);

        //        // 2.�����µĹ�ϵ

        //        foreach (StandardRoleInfo item in param.StandardRoles)
        //        {
        //            args.Clear();

        //            args.Add("JobId", param.Id);
        //            args.Add("StandardRoleId", item.Id);

        //            ibatisMapper.Insert(StringHelper.ToProcedurePrefix(string.Format("{0}_StandardRole_Insert", tableName)), args);
        //        }
