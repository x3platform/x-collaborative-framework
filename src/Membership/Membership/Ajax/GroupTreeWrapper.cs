...
namespace X3Platform.Membership.Ajax
{
    ...
    public class GroupTreeWrapper : ContextWrapper
    {
        ...
        public string Save(XmlDocument doc)
        {
            ...
            param = (GroupTreeInfo)AjaxStorageConvertor.Deserialize(param, doc);
        ...
        public string FindOne(XmlDocument doc)
        {
            ...
            outString.Append("{\"ajaxStorage\":" + AjaxStorageConvertor.Parse<GroupTreeInfo>(param) + ",");
        ...
        public string FindAll(XmlDocument doc)
        {
            ...
            outString.Append("{\"ajaxStorage\":" + AjaxStorageConvertor.Parse<GroupTreeInfo>(list) + ",");
