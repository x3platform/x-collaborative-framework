namespace X3Platform.Membership.Ajax
{
    ...
    public class ComputerWrapper
    {
        ...
        private IComputerService service = MembershipManagement.Instance.ComputerService;
        ...
        public string FindOne(XmlDocument doc)
        {
            ...
            IComputerInfo param = this.service.FindOne(id);
        ...
        public string GetPaging(XmlDocument doc)
        {
            ...
            IList<IComputerInfo> list = this.service.GetPaging(paging.RowIndex, paging.PageSize, paging.Query, out rowCount);
