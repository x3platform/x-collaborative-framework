namespace X3Platform.Membership.Ajax
{
    ...
    /// <summary></summary>
    public class CatalogWrapper : ContextWrapper
    {
        /// <summary>数据服务</summary>
        private ICatalogService service = MembershipManagement.Instance.CatalogService;
        ...
        public string FindAll(XmlDocument doc)
        {
            ...
            IList<CatalogInfo> list = this.service.FindAll(whereClause, length);

            outString.Append("{\"data\":" + AjaxUtil.Parse<CatalogInfo>(list) + ",");
        ...
        public string GetPaging(XmlDocument doc)
        {
            ...
            IList<CatalogInfo> list = this.service.GetPaging(paging.RowIndex, paging.PageSize, paging.Query, out rowCount);
