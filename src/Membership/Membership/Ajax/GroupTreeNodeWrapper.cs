namespace X3Platform.Membership.Ajax
{
    ...
    public class GroupTreeNodeWrapper : ContextWrapper
    {
        ...
        public string Save(XmlDocument doc)
        {
            ...
            param = (GroupTreeNodeInfo)AjaxUtil.Deserialize(param, doc);
        ...
        public string FindOne(XmlDocument doc)
        {
            ...
            outString.Append("{\"data\":" + AjaxUtil.Parse<GroupTreeNodeInfo>(param) + ",");
        ...
        public string FindAll(XmlDocument doc)
        {
            ...
            outString.Append("{\"data\":" + AjaxUtil.Parse<GroupTreeNodeInfo>(list) + ",");
        ...
        public string GetPaging(XmlDocument doc)
        {
            ...
            IList<GroupTreeNodeInfo> list = this.service.GetPaging(paging.RowIndex, paging.PageSize, paging.Query, out rowCount);
