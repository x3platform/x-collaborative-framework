...
namespace X3Platform.Membership.Ajax
{
    ...
    public class ContactWrapper : ContextWrapper
    {
        ...
        public string Save(XmlDocument doc)
        {
            ...
            param = (ContactInfo)AjaxStorageConvertor.Deserialize(param, doc);
        ...
        public string FindOne(XmlDocument doc)
        {
            ...
            outString.Append("{\"ajaxStorage\":" + AjaxStorageConvertor.Parse<ContactInfo>(param) + ",");
        ...
        public string FindAll(XmlDocument doc)
        {
            ...
            outString.Append("{\"ajaxStorage\":" + AjaxStorageConvertor.Parse<ContactInfo>(list) + ",");
        ...
        public string GetPages(XmlDocument doc)
        {
            ...
            IList<ContactInfo> list = this.service.GetPages(pages.RowIndex, pages.PageSize, pages.WhereClause, pages.OrderBy, out rowCount);
