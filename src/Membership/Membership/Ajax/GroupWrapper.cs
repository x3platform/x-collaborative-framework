namespace X3Platform.Membership.Ajax
{
    ...
    public class GroupWrapper : ContextWrapper
    {
        ...
        public string FindAll(XmlDocument doc)
        {
            ...
            outString.Append("{\"data\":" + AjaxUtil.Parse<IGroupInfo>(list) + ",");
        ...
        public string GetPaging(XmlDocument doc)
        {
            ...
            IList<IGroupInfo> list = this.service.GetPaging(paging.RowIndex, paging.PageSize, paging.Query, out rowCount);
