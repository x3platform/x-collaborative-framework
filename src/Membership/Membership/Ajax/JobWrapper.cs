...
namespace X3Platform.Membership.Ajax
{
    ...
    public class JobWrapper : ContextWrapper
    {
        ...
        public string FindAll(XmlDocument doc)
        {
            ...
            outString.Append("{\"data\":" + AjaxUtil.Parse<IJobInfo>(list) + ",");
        ...
        public string GetPaging(XmlDocument doc)
        {
            ...
            IList<IJobInfo> list = this.service.GetPaging(paging.RowIndex, paging.PageSize, paging.Query, out rowCount);
