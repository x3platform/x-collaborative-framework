...
//
// FileName     :AssignedJobWrapper.cs
//
// Description  :
//
...
namespace X3Platform.Membership.Ajax
{
    ...
    public class AssignedJobWrapper : ContextWrapper
    {
        ...
        public string FindOne(XmlDocument doc)
        {
            ...
            outString.Append("{\"ajaxStorage\":" + AjaxUtil.Parse<IAssignedJobInfo>(param) + ",");
        ...
        public string FindAll(XmlDocument doc)
        {
            ...
            outString.Append("{\"ajaxStorage\":" + AjaxUtil.Parse<IAssignedJobInfo>(list) + ",");
        ...
        public string GetPages(XmlDocument doc)
        {
            ...
            IAssignedJobInfo o = this.service.FindOne("0");

            IList<IAssignedJobInfo> list = this.service.GetPages(pages.RowIndex, pages.PageSize, pages.WhereClause, pages.OrderBy, out rowCount);
