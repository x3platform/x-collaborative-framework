namespace X3Platform.Membership.Ajax
{
    ...
    public sealed class MemberWrapper : ContextWrapper
    {
        ...
        public string GetPages(XmlDocument doc)
        {
            ...
            IList<IMemberInfo> list = this.service.GetPages(pages.RowIndex, pages.PageSize, pages.WhereClause, pages.OrderBy, out rowCount);
        ...
        public string Register(XmlDocument doc)
        {
            ...
            if (registerType == "email")
            {
                ...
                param.DisplayName = ((AccountInfo)param).Name = email;
