namespace X3Platform.Membership.ServiceObservers
{
    ...
    /// <summary></summary>
    public sealed class SyncAccountStatusServiceObserver : IServiceObserver
    {
        #region 属性:Name
        ...
        /// <summary></summary>
        public SyncAccountStatusServiceObserver()
            : this("SyncAccountStatus", string.Empty)
        {
        }

        /// <summary></summary>
        public SyncAccountStatusServiceObserver(string name, string args)
        {
            this.m_Name = name;
