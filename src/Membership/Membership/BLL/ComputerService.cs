namespace X3Platform.Membership.BLL
{
    ...
    public class ComputerService : IComputerService
    {
        ...
        private IComputerProvider provider = null;

        #region 构造函数:ComputerService()
        ...
        public ComputerService()
        {
            ...
            // 创建数据提供器
            this.provider = objectBuilder.GetObject<IComputerProvider>(typeof(IComputerProvider));
        }
        #endregion
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public IComputerInfo this[string id]
        {
